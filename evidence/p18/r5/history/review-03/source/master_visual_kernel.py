    ...
    for segment_index in range(len(points) - 1):
        ...
        if horizontal and marks:
            ...
            for bridge in ordered_marks:
                ...
                hop_start_x = bridge.point.x - direction * radius
                hop_end_x = bridge.point.x + direction * radius
                ...
                commands.append(
                    f"C {hop_start_x + direction * radius * 0.42:.2f} {bridge.point.y - radius:.2f} "
                    f"{bridge.point.x - direction * radius * 0.26:.2f} {bridge.point.y - radius:.2f} "
                    f"{bridge.point.x:.2f} {bridge.point.y - radius:.2f}"
                )
                commands.append(
                    f"C {bridge.point.x + direction * radius * 0.26:.2f} {bridge.point.y - radius:.2f} "
                    f"{hop_end_x - direction * radius * 0.42:.2f} {bridge.point.y - radius:.2f} "
                    f"{hop_end_x:.2f} {bridge.point.y:.2f}"
                )
