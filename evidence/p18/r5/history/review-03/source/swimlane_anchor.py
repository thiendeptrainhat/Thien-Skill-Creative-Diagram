...
def _bridge_svg(route: RoutedEdge) -> str:
    ...
    for bridge in route.bridges:
        ...
        arc = (
            ...
            f"C {x - radius * 0.58:.2f} {y - radius:.2f}, "
            f"{x - radius * 0.26:.2f} {y - radius:.2f}, {x:.2f} {y - radius:.2f} "
            f"C {x + radius * 0.26:.2f} {y - radius:.2f}, "
            f"{x + radius * 0.58:.2f} {y - radius:.2f}, {x + radius:.2f} {y:.2f}"
        )
        parts.extend(
            [
                ...
                f'<path class="bridge-hop-underlay" data-bridge-role="underlay" d="{arc}"/>',
