#!/usr/bin/env python3
"""Preserve the exact P-18R6 review-11 manifest-bound candidate."""
...
ARCHIVE = R6 / "history/review-11"
EXPECTED_MANIFEST_SHA256 = "69b93b45fc852b9e9c1405b66fbb40dd10d964fa55f589b65a51984d5b3dccfc"
EXPECTED_MANIFEST_ID = "P18R6-FOURTEEN-ENGINE-NEUTRAL-LIGHT-REVIEW-11-1.5.0"
...
def main() -> None:
    ...
    lineage = {
        ...
        "disposition": "HISTORICAL_SUPERSEDED_BY_OWNER_DIRECTED_P18R6_REVIEW_12_DIAGRAM_11_INLINE_CARDINALITY_KNOCKOUT_REMEDIATION",
        "authority": ["D-059", "D-060", "D-061", "D-062", "D-063", "D-064", "D-065", "D-066", "D-067", "D-068", "D-069", "D-070"],
    ...
    (ARCHIVE / "REVIEW-11-LINEAGE.json").write_text(
