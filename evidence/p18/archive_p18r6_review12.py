#!/usr/bin/env python3
"""Preserve the exact P-18R6 review-12 manifest-bound candidate."""
...
ARCHIVE = R6 / "history/review-12"
EXPECTED_MANIFEST_SHA256 = "90de78337c49f1ee42aae8730bbf072eb8bf679388038041b793f943ddfcafb6"
EXPECTED_MANIFEST_ID = "P18R6-FOURTEEN-ENGINE-NEUTRAL-LIGHT-REVIEW-12-1.5.0"
...
def main() -> None:
    ...
    lineage = {
        ...
        "disposition": "HISTORICAL_SUPERSEDED_BY_OWNER_DIRECTED_P18R6_REVIEW_13_DIAGRAM_14_SANKEY_NODE_OCCUPANCY_LABEL_ANCHOR_SQUARE_BAR_REMEDIATION",
        "authority": [
            "D-059", "D-060", "D-061", "D-062", "D-063", "D-064", "D-065",
            "D-066", "D-067", "D-068", "D-069", "D-070", "D-071",
        ],
    ...
    (ARCHIVE / "REVIEW-12-LINEAGE.json").write_text(
