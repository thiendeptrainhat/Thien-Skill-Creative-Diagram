#!/usr/bin/env python3
"""Preserve the exact P-18R6 review-13 manifest-bound candidate."""
...
ARCHIVE = R6 / "history/review-13"
EXPECTED_MANIFEST_SHA256 = "520c4ad74b944a218a576bdec7f100eb84054e712a066965417961fe97b91324"
EXPECTED_MANIFEST_ID = "P18R6-FOURTEEN-ENGINE-NEUTRAL-LIGHT-REVIEW-13-1.5.0"
...
def main() -> None:
    ...
    lineage = {
        ...
        "disposition": "HISTORICAL_SUPERSEDED_BY_OWNER_DIRECTED_P18R6_REVIEW_14_DIAGRAM_14_SANKEY_TOP_ROW_BAR_ALIGNMENT_REMEDIATION",
        "authority": [
            "D-059", "D-060", "D-061", "D-062", "D-063", "D-064", "D-065",
            "D-066", "D-067", "D-068", "D-069", "D-070", "D-071", "D-072",
        ],
    ...
    (ARCHIVE / "REVIEW-13-LINEAGE.json").write_text(
