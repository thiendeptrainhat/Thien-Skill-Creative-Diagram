#!/usr/bin/env python3
"""Preserve the exact P-18R6 review-01 manifest-bound candidate.

The archive is written once under ``evidence/p18/r6/history/review-01``.
Every copied byte is verified against the frozen review-01 manifest before the
active P-18R6 working set may be remediated.
"""
...
ARCHIVE = R6 / "history/review-01"
EXPECTED_MANIFEST_SHA256 = "fcdec11e49a00d89d82a3fafaba7cae2ac8e7c58908fa76cc2fa6eba383aad37"
EXPECTED_MANIFEST_ID = "P18R6-FOURTEEN-ENGINE-NEUTRAL-LIGHT-1.5.0"
...
def main() -> None:
    ...
    lineage = {
        ...
        "disposition": "HISTORICAL_SUPERSEDED_BY_OWNER_DIRECTED_P18R6_REVIEW_02_REMEDIATION",
        "authority": ["D-059", "D-060"],
    ...
    (ARCHIVE / "REVIEW-01-LINEAGE.json").write_text(
