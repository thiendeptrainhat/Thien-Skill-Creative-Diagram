#!/usr/bin/env python3
"""Preserve the exact P-18R6 review-10 manifest-bound candidate."""
...
ARCHIVE = R6 / "history/review-10"
EXPECTED_MANIFEST_SHA256 = "9a1fe7282db733c8239a0daf4abddff984c2372bfb6bb82f759de94980adaf84"
EXPECTED_MANIFEST_ID = "P18R6-FOURTEEN-ENGINE-NEUTRAL-LIGHT-REVIEW-10-1.5.0"
...
def main() -> None:
    ...
    lineage = {
        ...
        "disposition": "HISTORICAL_SUPERSEDED_BY_OWNER_DIRECTED_P18R6_REVIEW_11_DIAGRAM_11_CARDINALITY_AND_RELATIONSHIP_LABEL_REMEDIATION",
        "authority": ["D-059", "D-060", "D-061", "D-062", "D-063", "D-064", "D-065", "D-066", "D-067", "D-068", "D-069"],
    ...
    (ARCHIVE / "REVIEW-10-LINEAGE.json").write_text(
