#!/usr/bin/env python3
"""Preserve the exact P-18R6 review-15 manifest-bound candidate."""
...
ARCHIVE = R6 / "history/review-15"
EXPECTED_MANIFEST_SHA256 = "0e2fcddc00a5b993fd34b4376c32e10a1ca0dd64013202e58ac35df801798a5b"
EXPECTED_MANIFEST_ID = "P18R6-FOURTEEN-ENGINE-NEUTRAL-LIGHT-REVIEW-15-1.5.0"
...
def main() -> None:
    ...
    lineage = {
        ...
        "disposition": "HISTORICAL_SUPERSEDED_BY_OWNER_DIRECTED_P18R6_REVIEW_16_DIAGRAM_13_ORIGIN_ARROWHEAD_REMOVAL",
        "authority": [
            "D-059", "D-060", "D-061", "D-062", "D-063", "D-064", "D-065",
            "D-066", "D-067", "D-068", "D-069", "D-070", "D-071", "D-072", "D-073", "D-074",
        ],
    ...
    (ARCHIVE / "REVIEW-15-LINEAGE.json").write_text(
