...
**Authority:** D-051, D-052, D-058, D-059, D-060, D-061, D-062, D-063, D-064  
...
- Diagram 10 exposes a right-side annotation rail with `THE APEX`, `~4 / YR`, `~12 / YR` and `~240 / YR`. These notes bind respectively to apex, quarterly, monthly and workday cadence; each remains at least 56px outside the triangle, inside the artboard and vertically inside the corresponding layer band.
