...
def containment_anchor() -> Anchor:
    ...
    annotations = (
        ("THE APEX", 980.0, 232.0, 0, "semantic"),
        ("~4 / YR", 1065.0, 414.0, 1, "cadence-quarterly"),
        ("~12 / YR", 1170.0, 552.0, 2, "cadence-monthly"),
        ("~240 / YR", 1265.0, 682.0, 3, "cadence-workdays"),
    )
    ...
    parts.append("</g>")
    for value, x, y, layer_index, note_kind in annotations:
        ...
        parts.append(
            _text(
                ...
                y,
                value,
                "pyramid-annotation accent" if layer_index == 0 else "pyramid-annotation",
                **{
