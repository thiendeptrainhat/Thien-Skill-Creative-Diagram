...
def _orthogonal_path(
    ...
    **extra: object,
    ...
    """Serialize the approved small-radius rounded orthogonal route grammar."""

    route = tuple(_R5.Point(float(x), float(y)) for x, y in points)
    attrs: dict[str, object] = {"data-route-style": "rounded-orthogonal", **extra}
    if marker:
        attrs["marker-end"] = marker
    return _path(_R5.rounded_orthogonal_path(route, radius), cls, **attrs)
...
def _bridged_orthogonal_path(
    ...
    *,
    ...
    routed = _R5.bridged_orthogonal_path(route, (mark,), radius)
    hop = _R5.bridge_open_hop_path(mark)
    underlay = _R5.bridge_crown_underlay_path(mark)
    main = _path(
        routed,
        cls,
        **{
            "data-edge-id": edge_id,
            "data-route-style": "rounded-orthogonal",
...
def topology_anchor() -> Anchor:
    ...
    parts += [
        ...
        _orthogonal_path(((1040, 272), (1072, 272), (1072, 242), (1102, 242)), "wire", marker="url(#arrow)", **{"data-remediation": "D-060-01"}),
        _orthogonal_path(((1040, 322), (1072, 322), (1072, 482), (1102, 482)), "wire", marker="url(#arrow)", **{"data-remediation": "D-060-01"}),
...
def integration_anchor() -> Anchor:
    ...
    parts += [n1, n2, n3, n4, n5]
    parts += [
        _orthogonal_path(((406, 242), (466, 242), (466, 326), (520, 326)), "wire blue", marker="url(#arrow)", **{"data-remediation": "D-060-01"}),
        _orthogonal_path(((406, 492), (466, 492), (466, 382), (520, 382)), "wire dashed", marker="url(#arrow)", **{"data-remediation": "D-060-01"}),
        _orthogonal_path(((1020, 326), (1100, 326), (1100, 242), (1144, 242)), "wire accent", marker="url(#arrow-accent)", **{"data-remediation": "D-060-01"}),
        _orthogonal_path(((1020, 382), (1100, 382), (1100, 492), (1144, 492)), "wire", marker="url(#arrow)", **{"data-remediation": "D-060-01"}),
...
def deployment_anchor() -> Anchor:
    ...
    parts += [
        ...
        _orthogonal_path(((918, 380), (1000, 380), (1000, 350), (1080, 350)), "wire accent", marker="url(#arrow-accent)", **{"data-remediation": "D-060-01"}),
        _orthogonal_path(((918, 426), (1000, 426), (1000, 548), (1080, 548)), "wire", marker="url(#arrow)", **{"data-remediation": "D-060-01"}),
...
def dependency_anchor() -> Anchor:
    ...
    parts += [
        ...
        _bridged_orthogonal_path(((580, 646), (580, 740), (1220, 740), (1220, 780)), (790, 740, 1, 14), edge_id="dependency-types-zod"),
    ]
