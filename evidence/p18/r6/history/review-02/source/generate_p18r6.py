...
from gallery_kernel import Anchor, TYPOGRAPHY, anchors_without_swimlane, render_html
...
def main() -> None:
    ...
    inventory = {
        ...
        "lineage": {
            "review": "review-02",
            "supersedes_for_owner_review": "P18R6-FOURTEEN-ENGINE-NEUTRAL-LIGHT-1.5.0",
