...
def main() -> None:
    ...
    later_review_stems = {"13-quantitative--neutral-light"}
    pairwise_identity = []
    target_differences = []
    ...
    check(
        len(pairwise_identity) == 20 and all(pairwise_identity)
        and len(target_differences) == 6 and all(target_differences),
        "R6-D073-TARGETED-ANCHOR-DELTA-ONLY",
        "10 unaffected HTML/SVG pairs remain byte-identical to review-14; diagram 04/08/09 pairs carry D-073 and diagram 13 is reserved for D-074",
        results,
    )
    ...
    check(
        len(review_15_identity) == 26 and all(review_15_identity)
        and len(review_16_differences) == 2 and all(review_16_differences),
        "R6-D074-TARGETED-ANCHOR-DELTA-ONLY",
        "13 non-target HTML/SVG pairs are byte-identical to review-15; exactly diagram 13 HTML/SVG differ",
        results,
    )
