...
**Candidate:** `P18R6-FOURTEEN-ENGINE-NEUTRAL-LIGHT-REVIEW-09-1.5.0`  
**Authority:** D-051, D-052, D-058, D-059, D-060, D-061, D-062, D-063, D-064, D-065, D-066, D-067  
...
- Diagram 11 places `CUSTOMER`, `ORDER` and `PAYMENT` on one measured center-y; its two horizontal relationships connect exact center-side boundaries. `ORDER_ITEM` shares ORDER's center-x and the vertical relationship connects exact center boundaries. Every entity field stack keeps 32px measured bottom padding, exceeding the 24px minimum. Each relationship label publishes a real-font bbox and remains wholly inside its inter-node corridor with at least 8px clearance from adjacent node boxes.
