...
def containment_anchor() -> Anchor:
    ...
    cuts = (apex_y, 310.0, 460.0, 610.0, base_y)
    labels = (
        ("Flagship decision", "rare · highest leverage", 244.0, 278.0),
        ("Operating principles", "quarterly · durable", 382.0, 414.0),
        ("Reusable playbooks", "monthly · repeatable", 532.0, 564.0),
    ...
    for title, sub, title_y, sub_y in labels:
        parts += [_text(apex_x, title_y, title, "node-title", "middle"), _text(apex_x, sub_y, sub, "mono", "middle")]
    parts.append("</g>")
    parts += [
        ...
        _text(1160, 154, "APEX", "kicker"), _text(1160, 188, "defines direction", "mono"),
