...
def compartment_anchor() -> Anchor:
    ...
    def horizontal_relationship(source_id: str, target_id: str, relationship_name: str) -> str:
        ...
        cardinality_measured = {value: METRICS.measure("technical", value) for value in ("1", "N")}
        source_cardinality_x = corridor_left + 16.0
        target_cardinality_x = corridor_right - 16.0
        cardinality_line_clearance = 10.0
        cardinality_baseline_y = source_center_y - cardinality_measured["1"].descent - cardinality_line_clearance
        return "".join(
            (
                _line(
                    corridor_left,
                ...
                _text(
                    ...
                    cardinality_baseline_y,
                    "1",
                    "relationship-label cardinality-label",
                    **{
                        "data-relationship-cardinality": f"{relationship_id}:source",
                        "data-relationship-id": relationship_id,
                        "data-endpoint-role": "source",
                        "data-cardinality-value": "1",
                        "data-label-placement": "above",
                        "data-bbox-x": f"{source_cardinality_x:.2f}",
                        "data-bbox-y": f"{cardinality_baseline_y - cardinality_measured['1'].ascent:.2f}",
                        "data-bbox-width": f"{cardinality_measured['1'].width:.2f}",
                        "data-bbox-height": f"{cardinality_measured['1'].ascent + cardinality_measured['1'].descent:.2f}",
                        "data-node-clearance": "16.00",
                        "data-line-clearance": f"{cardinality_line_clearance:.2f}",
                        "data-node-boundary-x": f"{corridor_left:.2f}",
                        "data-minimum-clearance": "8.00",
                    },
                ),
                _text(
                    ...
                    "end",
                    **{
                        "data-relationship-cardinality": f"{relationship_id}:target",
                        "data-relationship-id": relationship_id,
                        "data-endpoint-role": "target",
                        "data-cardinality-value": "N",
                        "data-label-placement": "above",
                        "data-bbox-x": f"{target_cardinality_x - cardinality_measured['N'].width:.2f}",
                        "data-bbox-y": f"{cardinality_baseline_y - cardinality_measured['N'].ascent:.2f}",
                        "data-bbox-width": f"{cardinality_measured['N'].width:.2f}",
                        "data-bbox-height": f"{cardinality_measured['N'].ascent + cardinality_measured['N'].descent:.2f}",
                        "data-node-clearance": "16.00",
                        "data-line-clearance": f"{cardinality_line_clearance:.2f}",
                        "data-node-boundary-x": f"{corridor_right:.2f}",
                        "data-minimum-clearance": "8.00",
                    },
                ),
            )
    ...
    vertical_cardinality_x = order_center_x + 18
    vertical_source_baseline = order_y + order_h + 10 + vertical_cardinality["1"].ascent
    vertical_target_baseline = item_y - 10 - vertical_cardinality["N"].descent
    parts += [
        '<g data-schema-relationships="true" data-remediation="D-066" data-cardinality-remediation="D-069">',
        ...
        _text(
            ...
            vertical_source_baseline,
            "1",
            "relationship-label cardinality-label",
            **{
                "data-relationship-cardinality": "order-to-order-item:source",
                "data-relationship-id": "order-to-order-item",
                "data-endpoint-role": "source",
                "data-cardinality-value": "1",
                "data-label-placement": "right",
                "data-bbox-x": f"{vertical_cardinality_x:.2f}",
                "data-bbox-y": f"{vertical_source_baseline - vertical_cardinality['1'].ascent:.2f}",
                "data-bbox-width": f"{vertical_cardinality['1'].width:.2f}",
                "data-bbox-height": f"{vertical_cardinality['1'].ascent + vertical_cardinality['1'].descent:.2f}",
                "data-node-clearance": "10.00",
                "data-line-clearance": f"{vertical_cardinality_x - order_center_x:.2f}",
                "data-node-boundary-y": f"{order_y + order_h:.2f}",
                "data-minimum-clearance": "8.00",
            },
        ),
        _text(
            vertical_cardinality_x,
            vertical_target_baseline,
            "N",
            "relationship-label cardinality-label",
            **{
                "data-relationship-cardinality": "order-to-order-item:target",
                "data-relationship-id": "order-to-order-item",
                "data-endpoint-role": "target",
                "data-cardinality-value": "N",
                "data-label-placement": "right",
                "data-bbox-x": f"{vertical_cardinality_x:.2f}",
                "data-bbox-y": f"{vertical_target_baseline - vertical_cardinality['N'].ascent:.2f}",
                "data-bbox-width": f"{vertical_cardinality['N'].width:.2f}",
                "data-bbox-height": f"{vertical_cardinality['N'].ascent + vertical_cardinality['N'].descent:.2f}",
                "data-node-clearance": "10.00",
                "data-line-clearance": f"{vertical_cardinality_x - order_center_x:.2f}",
                "data-node-boundary-y": f"{item_y:.2f}",
                "data-minimum-clearance": "8.00",
            },
        ),
        "</g>",
