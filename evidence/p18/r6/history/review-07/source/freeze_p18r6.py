...
ANCHORS = R6 / "anchors"
REVIEW = R6 / "review"
CANDIDATE_ID = "P18R6-FOURTEEN-ENGINE-NEUTRAL-LIGHT-REVIEW-07-1.5.0"
...
def main() -> None:
    ...
    quicklook = {
        ...
        "implementer_visual_review": "PASS_AFTER_OWNER_DIRECTED_REVIEW_07_EQUAL_ANNOTATION_GAP_REMEDIATION",
    ...
    receipt = {
        ...
        "diagram_10_annotation_gap_receipt": json.loads((R6 / "P-18R6-INVENTORY.json").read_text(encoding="utf-8"))["diagram_10_annotation_gap"],
