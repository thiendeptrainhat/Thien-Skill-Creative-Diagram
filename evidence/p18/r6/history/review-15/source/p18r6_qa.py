...
from gallery_kernel import compartment_anchor, containment_anchor, dependency_anchor, deployment_anchor, experience_anchor, hierarchy_anchor, integration_anchor, matrix_anchor, special_anchor, topology_anchor
...
def main() -> None:
    ...
    check(
        len(pairwise_identity) == 22 and all(pairwise_identity)
        and len(target_differences) == 6 and all(target_differences),
        "R6-D073-TARGETED-ANCHOR-DELTA-ONLY",
        "11 non-target HTML/SVG pairs are byte-identical to review-14; exactly diagram 04/08/09 pairs differ",
        results,
    )
