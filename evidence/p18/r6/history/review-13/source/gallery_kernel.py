...
def special_anchor() -> Anchor:
    ...
    scale = 0.025
    nodes = (
        ("budget", "source", 90.0, 250.0, 42.0, 12000, "Monthly budget", "12,000 min", False),
    ...
    ribbons = (
        sankey_ribbon("budget-unit", "budget", "unit", 5200, 250.0, 210.0, TOKENS["line_soft"], .74),
        sankey_ribbon("budget-e2e", "budget", "e2e", 4000, 380.0, 430.0, TOKENS["line_soft"], .74),
        sankey_ribbon("budget-build", "budget", "build", 2800, 480.0, 650.0, TOKENS["line_soft"], .74),
    ...
    parts = [
        '<g data-sankey-contract="D-071" data-total-value="12000" data-scale-px-per-minute="0.025" '
