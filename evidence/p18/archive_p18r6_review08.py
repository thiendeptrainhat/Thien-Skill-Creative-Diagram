#!/usr/bin/env python3
"""Preserve the exact P-18R6 review-08 manifest-bound candidate."""
...
ARCHIVE = R6 / "history/review-08"
EXPECTED_MANIFEST_SHA256 = "a5e58ccb47ea63b6904e84859aace63fb3f09b2cb3147e4a3a96ce41617eb7ec"
EXPECTED_MANIFEST_ID = "P18R6-FOURTEEN-ENGINE-NEUTRAL-LIGHT-REVIEW-08-1.5.0"
...
def main() -> None:
    ...
    lineage = {
        ...
        "disposition": "HISTORICAL_SUPERSEDED_BY_OWNER_DIRECTED_P18R6_REVIEW_09_DIAGRAM_12_AXIS_ANNOTATION_REMEDIATION",
        "authority": ["D-059", "D-060", "D-061", "D-062", "D-063", "D-064", "D-065", "D-066", "D-067"],
    ...
    (ARCHIVE / "REVIEW-08-LINEAGE.json").write_text(
