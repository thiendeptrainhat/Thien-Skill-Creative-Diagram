#!/usr/bin/env python3
"""Preserve the exact P-18R6 review-03 manifest-bound candidate."""
...
ARCHIVE = R6 / "history/review-03"
EXPECTED_MANIFEST_SHA256 = "572de899399755268d63fa5cb49c598a6ee6c5d509418ed8d07484a750c62e54"
EXPECTED_MANIFEST_ID = "P18R6-FOURTEEN-ENGINE-NEUTRAL-LIGHT-REVIEW-03-1.5.0"
...
def main() -> None:
    ...
    lineage = {
        ...
        "disposition": "HISTORICAL_SUPERSEDED_BY_OWNER_DIRECTED_P18R6_REVIEW_04_CONTAINMENT_REMEDIATION",
        "authority": ["D-059", "D-060", "D-061", "D-062"],
    ...
    (ARCHIVE / "REVIEW-03-LINEAGE.json").write_text(
