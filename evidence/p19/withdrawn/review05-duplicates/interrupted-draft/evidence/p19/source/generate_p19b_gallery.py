...
def specimen_sources() -> list[tuple[str, str, dict]]:
    ...
    canonical['sankey'] = sankey_fixture()
...
def main() -> None:
    ...
    for record in records:
        ...
        if record['canonical_type'] == 'sankey':
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "P-19B D-083 six-station/shared-state flywheel remediation inheriting P-18R6 review-17; owner visual approval and P-19C are not performed.",
    })
