...
- Gallery hiện hành theo D-084/D-085/D-086/D-087 dùng trực tiếp 14 anchor P-18 review-17 đã duyệt ở `neutral-light`, không tạo P-19 trùng loại. P-19 chỉ sinh 25 canonical type × ba mode = 75 HTML và bốn capability × ba mode = 12 HTML, tổng 87 specimen; trang tổng hợp có 14 + 87 = 101 diagram. D-086 sửa riêng Fishbone; D-087 sửa riêng dp-integration thành topology 3 nguồn + 3 lõi nền tảng + 3 consumer + 2 dịch vụ dùng chung, giữ nguyên scope gallery và mọi diagram khác. Yêu cầu 129 HTML P-19 trước đây là historical, đã được thay thế trong phạm vi gallery này; taxonomy/semantic source vẫn 39 type + bốn capability.
