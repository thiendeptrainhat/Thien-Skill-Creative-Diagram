...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-29",
        "boundary": "P-19B D-087 dp-integration-only remediation retaining D-084/D-085/D-086 scope; 14 approved P-18 anchors + 87 P-19 HTML; owner review pending; P-19C not performed",
