...
from verify_p19b_review07 import verify
...
class ReuseScopeTests(unittest.TestCase):
    ...
    def test_capabilities_and_recent_fixes_retained(self):
        ...
        for name in ('gantt', 'loop-flywheel', 'fishbone', 'dp-integration', 'CAP-V17', 'CAP-V18', 'CAP-V19', 'CAP-V20'):
    ...
    def test_exact_preservation_and_recoverable_withdrawal(self):
        ...
        self.assertEqual(report['dp_integration_html_changed'], 3)
        self.assertEqual(report['non_target_html_artwork_preserved'], 84)
