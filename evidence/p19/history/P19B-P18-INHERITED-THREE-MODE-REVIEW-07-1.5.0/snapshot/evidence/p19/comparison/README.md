...
- Preserve: exact P-18R6 review-17 SVG bytes; all non-target P-19B review-06
  artwork, typography, colors, text, geometry and paint order. Review-07 changes
  only dp-integration relative to archived review-06; review-06's detailed
  Fishbone remains intact.
