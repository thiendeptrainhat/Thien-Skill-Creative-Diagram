...
- 39 canonical type × 3 static visual mode = 117 standalone HTML;
- 4 capability mới × 3 static visual mode = 12 standalone HTML;
- tổng tối thiểu 129 specimen HTML, chưa tính `index.html`/contact sheet;
- 129/129 file phải có semantic fixture ID, type/parent/mode metadata, exact hash và automated check disposition;
