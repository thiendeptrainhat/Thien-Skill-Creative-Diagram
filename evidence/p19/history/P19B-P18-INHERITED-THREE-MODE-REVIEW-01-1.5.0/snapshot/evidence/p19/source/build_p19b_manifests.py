...
CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-01-1.5.0"
...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-27",
        "boundary": "P-19B D-080 remediation candidate; technically ready for owner visual review; P-19C not performed",
