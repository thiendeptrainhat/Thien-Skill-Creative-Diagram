...
PINS = {
    ...
    "evidence/p19/gallery/P-19B-MANIFEST.json": "9ef8813f41bac8c7d4eb043321455b5be4433410e838a6e2844af27f4d7780b7",
    "evidence/p19/P-19B-SOURCE-MANIFEST.json": "c0a05801795ac93f28db230cc620070b2aac3e2a46df8582a9ba0d8e1f02281b",
    "evidence/p19/P-19B-PLAN-MANIFEST.json": "53cecefc0f6b7300f88a9183c9735847ddf8f391239479a789d8a60f176a8680",
...
<h1>P-18 ↔ P-19<br>Toàn bộ diagram, cùng một trang.</h1>
    ...
    <p class="note">Theo D-084/D-085/D-095–D-113: <strong>giữ nguyên 14 bản P-18, bỏ các bản P-19 trùng loại, giữ mọi remediation trước và bổ sung riêng scatter-chart dưới frozen parent scatter-plot</strong>. P-19 có 25 loại + 4 capability + 2 presentation variant, mỗi identity đủ 3 mode; P-18 chỉ dùng neutral-light đã duyệt, không tự tạo thêm màu.</p>
...
<a href="{link(P18 / 'index.html')}" target="_blank" rel="noopener">Mở gallery P-18 ↗</a></div>
    <div><strong>P-19B · review-33 · Chờ owner review</strong><code>{html.escape(b['candidate_id'])}</code>
