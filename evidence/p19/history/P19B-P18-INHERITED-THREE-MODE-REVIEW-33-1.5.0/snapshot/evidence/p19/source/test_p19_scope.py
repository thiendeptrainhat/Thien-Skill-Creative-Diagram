...
from verify_p19b_review33 import verify
...
class ReuseScopeTests(unittest.TestCase):
    ...
    def test_exact_preservation_and_recoverable_withdrawal(self):
        ...
        self.assertEqual(report['new_target_html_count'], 3)
        ...
        self.assertEqual(report['scatter_measurement']['points'], 12)
        self.assertEqual(report['scatter_measurement']['focal'], 1)
