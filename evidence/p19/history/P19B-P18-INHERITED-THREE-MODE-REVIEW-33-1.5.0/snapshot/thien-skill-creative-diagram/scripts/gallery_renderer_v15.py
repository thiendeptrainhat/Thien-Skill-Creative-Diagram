...
P19B_CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-33-1.5.0"
...
def render_gallery_html(ir_value: Mapping[str, Any], mode: str, fixture_id: str, *, connector_corner_style: str | None = None) -> str:
    ...
    detailed_types = ("gantt", "loop-flywheel", "dp-integration", "sequence", "bar-chart", "line-chart", "scatter-plot", "polar-chart", "treemap", "wardley-map", "venn", "dp-security-matrix", "er-data-model", "uml-class", "high-level", "it-current-state", "kanban", "story-map", "state-machine", "layer-stack", "medallion", "tree")
    detailed_ready = (
