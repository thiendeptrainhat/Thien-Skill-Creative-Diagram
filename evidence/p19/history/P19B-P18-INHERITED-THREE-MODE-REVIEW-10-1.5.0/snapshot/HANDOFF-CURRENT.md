# Handoff phiên mới — P-19B D-090 review-10 detailed er-data-model; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-090.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-10-1.5.0` theo D-090, giữ scope D-084–D-089: 14 P-18 anchor + 87 P-19 HTML/29 preview. ER data model có 4 entity/19 member/3 relationship/1 aggregate root/1 associative entity; focused 89/89, scope 8/8, static 32/32 và regression 251/251 PASS. Browser `blocked / not executable`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-090; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086 khóa Fishbone, D-087 khóa dp-integration, D-088 khóa bar-chart, D-089 khóa dp-security-matrix và D-090 giới hạn review-10 ở er-data-model
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-090 review-10 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
