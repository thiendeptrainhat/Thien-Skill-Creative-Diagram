...
def main() -> None:
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-090: detailed er-data-model-only remediation retaining D-089 dp-security-matrix, D-088 bar-chart, D-087 dp-integration, D-086 Fishbone and D-085 selection; 87 P-19 HTML, no owner approval or P-19C claim.",
    })
