...
- Preserve: exact P-18R6 review-17 SVG bytes and all non-target P-19B review-09
  artwork, typography, colors, text, geometry and paint order. Review-10 changes
  only er-data-model relative to archived review-09; detailed Fishbone,
  dp-integration, bar-chart and dp-security-matrix remain intact.
