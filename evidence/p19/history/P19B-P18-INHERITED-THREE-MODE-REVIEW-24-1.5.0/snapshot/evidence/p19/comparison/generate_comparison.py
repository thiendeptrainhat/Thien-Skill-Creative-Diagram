...
PINS = {
    ...
    "evidence/p19/gallery/P-19B-MANIFEST.json": "692d865ace246da3c68deee9900f71c9381de69fbe01cc0cb31cb4ee547ccd98",
    "evidence/p19/P-19B-SOURCE-MANIFEST.json": "133aab431bb4913801298136cd957a5fce777c30cc96298c9c6168abca6c28ce",
    "evidence/p19/P-19B-PLAN-MANIFEST.json": "42c54d8af02ec9e3f8448e5d788d3d83ef37bda925df5b272b35aa2ec61087a5",
...
<h1>P-18 ↔ P-19<br>Toàn bộ diagram, cùng một trang.</h1>
    ...
    <p class="note">Theo D-084/D-085/D-095–D-104: <strong>giữ nguyên 14 bản P-18, bỏ các bản P-19 trùng loại, giữ mọi remediation trước và thay riêng UML-class bằng detailed typed model</strong>. P-19 có 25 loại + 4 capability + 1 presentation variant, mỗi identity đủ 3 mode; P-18 chỉ dùng neutral-light đã duyệt, không tự tạo thêm màu.</p>
