...
def main() -> None:
    ...
    if len(sources) != 30:
        raise RuntimeError("D-104 requires 25 canonical fixtures, four capability fixtures, one Layers variant, and the detailed typed UML class model")
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-104: replaced the UML-class specimen with an original seven-container, five-relation typed UML model and complete six-kind relationship legend; retained D-103–D-085 scope; 90 P-19 HTML, no owner approval or P-19C claim.",
    })
