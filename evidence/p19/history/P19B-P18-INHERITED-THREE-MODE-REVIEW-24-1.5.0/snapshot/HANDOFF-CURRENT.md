# Handoff phiên mới — P-19B D-104 review-24 detailed typed UML-class; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-104.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-24-1.5.0` theo D-104, giữ scope D-084–D-103: 14 P-18 anchor + 90 P-19 HTML/30 preview. `uml-class` có 7 container/17 member/5 continuous typed relationship, 4 inline cardinality và legend đủ 6 loại. Exact review-23 đã archive; 87 non-target HTML/29 non-target preview được bảo toàn. Focused 183/183, scope 8/8, static 34/34 và regression 345/345 PASS; browser `BLOCKED_URL_POLICY`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-104; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086–D-103 khóa các remediation/addition chi tiết và D-104 khóa detailed typed `uml-class`
...
### D-104 checkpoint hiện hành

Exact review-23 đã archive byte-bound trước mutation: 428 snapshot file và 8824 protected file khớp. Active review-24 thay riêng `uml-class` bằng seven-container/five-relation typed model: 17 member, một focal interface có stereotype trực tiếp, 1 dependency, 2 realization, 1 composition, 1 association, 4 cardinality inline và legend đủ 6 relationship kind. Cả 5 semantic connector là một continuous path; association dùng hai góc bo tròn 90° theo P-18. Chỉ 3 target HTML + 1 preview đổi artwork; 87 non-target HTML giữ artwork sau candidate normalization và 29 non-target preview byte-identical. Focused 183/183, scope 8/8, static 34/34 và regression 345/345 PASS; neutral-light Quick Look raster đã inspect. Xem `evidence/p19/P-19B-REVIEW-24-VERIFICATION.json`; owner approval pending, P-19C/G-04/package/release chưa được phép.
...
- Active P-19B review-24: focused 183/183, scope 8/8, static 34/34 và regression 345/345 PASS; UML-class 7 container/17 member/5 continuous typed relationship, 4 inline cardinality, 6 legend kind và cùng geometry qua ba mode; 87 non-target HTML giữ artwork, 29 preview byte-identical và exact P-18 anchors giữ nguyên. Quick Look chỉ là focused local raster, browser bị URL policy chặn; không thay browser/full visual PASS và không mở P-19C.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-104 review-24 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
