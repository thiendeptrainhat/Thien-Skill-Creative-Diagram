"""D-104 detailed UML class layout with typed, continuous relationships."""
...
BOXES = {
    "class-billing-service": (60, 90, 560, 165),
    "interface-payment-option": (800, 50, 720, 205),
    "class-digital-wallet": (720, 425, 410, 230),
    "class-wire-transfer": (1300, 425, 410, 200),
...
RELATIONSHIPS = {
    "relation-service-uses-option": {
        ...
        "kind": "dependency", "path": "M620 172.5 H800", "label": "USES",
        "label_position": (710, 147), "marker_end": "url(#uml-open-arrow)",
    },
    "relation-wallet-realizes-option": {
        "source": "class-digital-wallet", "target": "interface-payment-option",
        "kind": "realization", "path": "M925 425 V255", "label": "",
    ...
    "relation-wire-realizes-option": {
        ...
        "kind": "realization", "path": "M1505 425 V255", "label": "",
        "label_position": None, "marker_end": "url(#uml-hollow-triangle)",
    },
...
def render_uml_class(plan):
    ...
    parts = ['<g data-uml-class-contract="D-104-seven-container-five-relation-model">', _defs()]
    ...
    for relation_id in EXPECTED_RELATIONSHIPS:
        ...
        parts.append(f'<path class="{css}" data-uml-relation-id="{relation_id}" data-relation-kind="{relation["kind"]}" data-source="{relation["source"]}" data-target="{relation["target"]}" data-continuous-subpaths="1" d="{relation["path"]}"{marker_start}{marker_end}/>')
