...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-114 radar remediation, retaining D-085–D-113 scope; frozen P-17/P-19A/P-18 preserved; 14 approved P-18 anchors + 93 P-19 HTML; owner review pending; P-19C not performed",
