...
from verify_p19b_review34 import verify
...
class ReuseScopeTests(unittest.TestCase):
    ...
    def test_exact_preservation_and_recoverable_withdrawal(self):
        ...
        self.assertEqual(report['radar_measurement']['profiles'], 4)
        self.assertEqual(report['radar_measurement']['values'], 20)
        self.assertEqual(report['radar_measurement']['focal'], 1)
