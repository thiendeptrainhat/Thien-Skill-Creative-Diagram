"""Preserve the exact D-081 candidate before the owner-authorized D-082 change."""
import hashlib
import json
...
DEST = ROOT / 'evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-02-1.5.0'
PINS = {
...
def main():
    ...
    receipt = {'candidate_id': 'P19B-P18-INHERITED-THREE-MODE-REVIEW-02-1.5.0',
               'disposition': 'historical before D-082 Gantt-only redesign; not owner approval',
