#!/usr/bin/env python3
"""Preserve exact D-113 review-33 before D-114 radar remediation."""
import hashlib
import json
import shutil
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-33-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        ...
        "disposition": "historical before D-114 radar remediation; not owner approval",
