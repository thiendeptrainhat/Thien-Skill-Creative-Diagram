# Handoff phiên mới — P-19B D-121 review-41 slope-graph; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-121.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-41-1.5.0` theo D-121, giữ scope D-084–D-120: 14 P-18 anchor + 93 P-19 HTML/31 preview. Review-41 đổi display identity `CAP-V18-SLOPEGRAPH` thành `slope-graph`, giữ internal `CAP-V18`/parent `line-chart`, và thay riêng artwork bằng slope graph 7 series/14 endpoint/2 state/1 focal trên cùng thang 0–100%, có direct label, rise/fall/rank/crossing; template hiện tại giữ nguyên. 90 non-target HTML/30 preview được bảo toàn. Exact review-40 đã archive 602 file; 17540 protected file khớp. Owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-121; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-105 khóa global connector policy, D-113 khóa scatter-chart, D-114 khóa detailed radar, D-115 khóa solid-line radar, D-116 khóa marker-free radar plot, D-117 khóa detailed five-shape process, D-118 khóa continuous document connectors, D-119 khóa thin-stroke process, D-120 khóa Bubble identity/chart và D-121 khóa slope-graph identity/chart
...
### D-121 checkpoint hiện hành

Exact review-40 đã archive byte-bound trước mutation: 602 snapshot file và 17540 protected file khớp. Active review-41 đổi display identity thành `slope-graph` nhưng giữ internal `CAP-V18`/parent `line-chart`; chart có đúng 7 series, 14 endpoint, 2 plain state axis, 6 tick, 5 rise, 2 fall, 9 crossing, 1 focal và 7 exact table row trên cùng thang 0–100%. Direct label/value đủ hai đầu; ba mode cùng geometry. Focused/scope 10/10, static 34/34, full regression 399/399 và exact verifier PASS; neutral-light raster 2000×980 đã inspect. Owner approval pending; P-19C/G-04/package/release chưa được phép.
...
- P-17 semantic source vẫn đủ 39 type + bốn capability; P-19A registry không đổi. Gallery hiện hành giữ trực tiếp 14 P-18 anchor ở neutral-light, sinh 93 HTML P-19/31 identity theo D-085/D-095–D-121, gồm hai presentation variant `layers`/`scatter-chart`, display identity `slope-graph` với internal `CAP-V18` và `bubble` với internal `CAP-V20`, đồng thời giữ global connector policy D-105 cùng mọi detailed remediation trước; owner approval pending.
