#!/usr/bin/env python3
"""Preserve exact D-110 review-30 before detailed sequence review-31."""
import hashlib
import json
import shutil
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-30-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        ...
        "disposition": "historical before D-111 detailed sequence remediation; not owner approval",
