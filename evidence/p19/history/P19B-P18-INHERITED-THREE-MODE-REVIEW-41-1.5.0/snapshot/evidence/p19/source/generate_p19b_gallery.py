...
def specimen_sources() -> list[tuple[str, str, dict]]:
    ...
    values.extend(
        (
            ...
            CAPABILITY_NAMES[capability] if capability in {"CAP-V18", "CAP-V20"} else capability,
            variants[capability],
        )
...
def main() -> None:
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097/D-098/D-099/D-100/D-105/D-106/D-108/D-109/D-110/D-111/D-112/D-113/D-114/D-115/D-116/D-117/D-118/D-119/D-120/D-121",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-121: renamed the CAP-V18 display identity to slope-graph while retaining CAP-V18 as the internal capability id and line-chart as canonical parent; replaced only its three visual modes with an original seven-series, two-state slope comparison using the inherited P-18 template, direct exact endpoint labels, rank/direction/crossing preservation and one redundantly identified focal series; retained D-120–D-085 scope; 93 P-19 HTML, no owner approval or P-19C claim.",
    })
