...
D-084/D-085/D-086/D-087/D-088/D-089/D-090/D-091/D-092/D-093/D-094/D-095/D-096/D-097/D-098/D-099/D-100/D-101/D-102/D-103/D-104/D-105/D-106/D-107/D-108/D-109/D-110/D-111/D-112/D-113/D-114/D-115/D-116/D-117/D-118/D-119/D-120/D-121.
...
- Preserve: exact P-18R6 review-17 SVG bytes and all 90 non-target P-19B artworks,
  typography, colors, text and geometry. Review-41 changes only CAP-V18's display
  identity/artwork under D-121, retaining internal `CAP-V18`, parent `line-chart`
  and the existing template; all retained diagrams remain intact.
...
- Keep all four capabilities, including display identity `slope-graph` whose internal
  ID is `CAP-V18` and canonical parent is `line-chart`, plus `bubble`/`CAP-V20`/`scatter-plot`. Do not infer deletion
