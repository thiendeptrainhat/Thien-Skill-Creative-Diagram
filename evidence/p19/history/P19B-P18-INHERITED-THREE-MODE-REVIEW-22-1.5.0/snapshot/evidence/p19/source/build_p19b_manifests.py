...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-102 bordered exact-area Treemap retaining D-084–D-101 scope; six continent leaves/six proportional rectangles with visible borders/exact hierarchy total/one focal and one compact-label tile; frozen P-17/P-19A preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
