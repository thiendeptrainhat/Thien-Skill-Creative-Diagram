# Handoff phiên mới — P-19B D-102 review-22 bordered exact-area Treemap; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-102.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-22-1.5.0` theo D-102, giữ scope D-084–D-101: 14 P-18 anchor + 90 P-19 HTML/30 preview. `treemap` giữ 6 leaf/6 exact-area tile và bổ sung 6 visible outline/6 separation gutter ở đủ ba mode. Exact review-21 đã archive; 87 non-target HTML/29 non-target preview được bảo toàn. Focused 175/175, scope 8/8, static 34/34 và regression 337/337 PASS; browser `BLOCKED_URL_POLICY`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-102; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086–D-101 khóa các remediation/addition chi tiết và D-102 khóa visible border cho exact-area `treemap`
...
### D-102 checkpoint hiện hành

Exact review-21 đã archive byte-bound trước mutation. Active review-22 chỉ thay paint treatment của `treemap`: sáu tile giữ nguyên exact area/value geometry nhưng mỗi tile có canvas gutter under-stroke và visible outline; năm tile thường dùng connector stroke, Châu Á dùng coral stroke. Archive 410 file và protected corpus 7993 file khớp; 87 non-target HTML giữ artwork sau candidate-ID normalization, 29 non-target preview byte-identical; tổng vẫn 90 P-19 HTML/30 preview và comparison có 104 diagram. Focused 175/175, scope 8/8, static 34/34 và regression 337/337 PASS; neutral-light Quick Look raster đã inspect. In-app browser từ chối local file URL theo policy nên browser là `BLOCKED_URL_POLICY`, không bypass. Xem `evidence/p19/P-19B-REVIEW-22-VERIFICATION.json`; owner approval pending, P-19C/G-04/package/release chưa được phép.
...
- Active P-19B review-22: focused 175/175, scope 8/8, static 34/34 và regression 337/337 PASS; Treemap 6 leaf/6 exact-area tile, 6 visible outline/6 separation gutter, exact total, một focal và một compact-label tile cùng geometry qua ba mode; 87 non-target HTML giữ artwork, 29 preview byte-identical và exact P-18 anchors giữ nguyên. Quick Look chỉ là focused local raster, browser bị URL policy chặn; không thay browser/full visual PASS và không mở P-19C.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-102 review-22 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
