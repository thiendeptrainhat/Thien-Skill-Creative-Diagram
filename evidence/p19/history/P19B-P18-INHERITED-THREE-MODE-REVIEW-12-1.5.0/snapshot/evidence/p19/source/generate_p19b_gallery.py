...
def main() -> None:
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-092: high-level data-platform topology remediation with P-18 visual inheritance and continuous orthogonal connectors; rounded 90-degree corners by default, straight only when explicitly requested; retaining D-091–D-085 scope; 87 P-19 HTML, no owner approval or P-19C claim.",
    })
