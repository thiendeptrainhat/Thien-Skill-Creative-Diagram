...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-29",
        "boundary": "P-19B D-092 high-level-only detailed data-platform remediation retaining D-084–D-091 scope; P-18 rounded orthogonal connector policy; 14 approved P-18 anchors + 87 P-19 HTML; owner review pending; P-19C not performed",
