...
**Cập nhật:** 2026-08-29  
**Phạm vi được phép trong yêu cầu hiện tại:** D-084/D-085: dùng trực tiếp 14 P-18 approved anchor, rút duplicate khỏi P-19; generator sinh 87 HTML cho 25 type + 4 capability × 3 mode; cập nhật gallery/trang tổng hợp/evidence/handoff, giữ artwork còn lại và mọi frozen/release bytes.
**Phase đang thực hiện:** P-19B review-12 `in-progress`/owner-review-pending theo D-092, giữ scope D-084–D-091; exact review-11 archived; P-19 tổng thể `in-progress`; P-19C `not-started` và unauthorized
**Quyền triển khai skill/gallery:** chỉ sửa P-19B active source/gallery/evidence/governance để tạo candidate kế nhiệm; không sửa exact review-17, frozen P-18R5 review-04, historical P-18R6 review-01→review-16, exact P-19A candidate hoặc archived P-19B initial candidate; không chạy P-19C full QA/freeze/masked/owner review hoặc sửa package
...
4. `P-19A` — 39+4 type/capability adapters, đã hoàn tất theo D-078; `P-19B` — remediation theo D-084/D-085 đang `in-progress`, kết hợp 14 P-18 anchor với 87 P-19 HTML sau owner rejection của candidate đầu; `P-19C` — full QA/freeze/owner review, chưa được phép và vẫn cần authorization riêng.
...
2. `P-19B` — remediation `in-progress` theo D-084–D-092: dùng trực tiếp 14 exact P-18R6 review-17 anchor, không tái sinh duplicate; 25 canonical type còn lại và bốn capability có ba mode, tổng 87 HTML/29 preview. Active review-12 giữ toàn bộ D-086–D-091 và thay riêng high-level bằng data-platform topology chi tiết; connector orthogonal là một path liên tục, góc 90° bo tròn mặc định và thẳng chỉ khi khai báo. Giữ gallery/comparison đủ 101 diagram, không derive thêm màu P-18, bảo toàn artwork P-19 ngoài high-level/candidate metadata và giữ withdrawal custody để khôi phục.
...
**Verification dự kiến:** theo D-085, union 14 P-18 canonical + 25 P-19 canonical phải đúng 39 và không trùng; P-19 có 75 canonical + 12 capability HTML, 29 preview, đủ ba mode cho 29 identity. P-18 phải giữ exact bytes/hash ở neutral-light, không claim ba-mode coverage cho 14 anchor này. Kiểm absence of withdrawn files, links, deterministic generation, retained artwork và recoverable custody; owner vẫn phải duyệt exact current gallery.
...
**Checkpoint D-092:** active candidate `P19B-P18-INHERITED-THREE-MODE-REVIEW-12-1.5.0`. Review-11 đã archive 283 files; protected corpus 4561 files khớp hash. Chỉ 3 high-level HTML và preview high-level thay artwork; 84 non-target HTML giữ nguyên sau candidate-ID normalization, 28 non-target preview byte-identical. High-level có đúng 11 node/13 directed edge/2 boundary group; cả 13 connector là một path liên tục, mọi bend 90° dùng quadratic rounded join theo mặc định và straight chỉ qua explicit override; geometry ba mode được giữ. Focused 99/99, scope 8/8, static 32/32 và full regression 261/261 PASS sau transient-cache cleanup; neutral-light raster đã inspect. Chi tiết `evidence/p19/P-19B-REVIEW-12-VERIFICATION.json`; browser blocked, owner approval pending, P-19C unauthorized, G-04 NOT-EVALUATED.
