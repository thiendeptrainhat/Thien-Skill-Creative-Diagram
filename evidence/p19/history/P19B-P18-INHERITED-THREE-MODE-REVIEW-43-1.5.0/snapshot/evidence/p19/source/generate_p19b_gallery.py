...
def main() -> None:
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-123: renamed the CAP-V19 display identity to ridgeline while retaining CAP-V19 as the internal capability id and line-chart as canonical parent; replaced only its three visual modes with an original twelve-series shared-domain Gaussian-KDE distribution chart using the inherited P-18 template, nested 50/80/95% quantile bands, direct medians, one shared-median reference and one redundantly identified focal row; retained D-122–D-085 scope; 93 P-19 HTML, no owner approval or P-19C claim.",
    })
