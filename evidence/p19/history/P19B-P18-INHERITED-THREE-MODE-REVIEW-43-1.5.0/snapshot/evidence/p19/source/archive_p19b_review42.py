#!/usr/bin/env python3
"""Preserve exact D-122 review-42 before D-123 ridgeline remediation."""
import hashlib
import json
import shutil
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-42-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        ...
        "disposition": "historical before D-123 ridgeline display rename and detailed distribution redraw; not owner approval",
        "manifest_pins": PINS,
