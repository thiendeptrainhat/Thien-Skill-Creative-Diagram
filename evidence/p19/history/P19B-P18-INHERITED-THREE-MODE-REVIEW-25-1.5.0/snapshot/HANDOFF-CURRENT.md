# Handoff phiên mới — P-19B D-105 review-25 global connector policy; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-105.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-25-1.5.0` theo D-105, giữ scope D-084–D-104: 14 P-18 anchor + 90 P-19 HTML/30 preview. Đủ 90 SVG khai báo global centered/even straight-first connector policy; UML proof có exact centered single port, equal `360/360/360` multi-port intervals, 4 straight relation và 1 documented rounded-orthogonal exception. Exact review-24 đã archive 440 file; 9253 protected file khớp. Scope 8/8, static 34/34 và regression 351/351 PASS; browser `BLOCKED_URL_POLICY`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-105; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086–D-104 khóa các remediation/addition chi tiết và D-105 khóa global connector policy
...
- P-17 semantic source vẫn đủ 39 type + bốn capability; P-19A registry không đổi. Gallery hiện hành giữ trực tiếp 14 P-18 anchor ở neutral-light, sinh 90 HTML P-19/30 identity theo D-085/D-095–D-104 và áp dụng global connector policy theo D-105; owner approval pending.
...
- Active P-19B review-25: scope 8/8, static 34/34 và regression 351/351 PASS; đủ 90 SVG khai báo D-105, UML proof đạt exact centered/even ports và straight-first route; 87 non-target HTML giữ artwork sau policy normalization và exact P-18 anchors giữ nguyên. Quick Look chỉ là focused local raster, browser bị URL policy chặn; không thay browser/full visual PASS và không mở P-19C.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-105 review-25 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
