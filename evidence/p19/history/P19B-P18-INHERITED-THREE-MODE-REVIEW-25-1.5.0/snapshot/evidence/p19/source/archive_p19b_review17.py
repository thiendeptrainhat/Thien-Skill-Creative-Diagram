#!/usr/bin/env python3
"""Preserve exact D-097 review-17 before polar-chart review-18."""
import hashlib
import json
import shutil
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-17-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        ...
        "disposition": "historical before D-098 polar-chart remediation; not owner approval",
        "manifest_pins": PINS,
