...
from verify_p19b_review25 import verify
...
class ReuseScopeTests(unittest.TestCase):
    ...
    def test_exact_preservation_and_recoverable_withdrawal(self):
        ...
        self.assertEqual(report['non_target_html_artwork_preserved_after_policy_normalization'], 87)
        self.assertEqual(report['two_ports_equal_intervals'], [360, 360, 360])
        self.assertEqual(report['straight_relations'], 4)
        self.assertEqual(report['documented_orthogonal_exceptions'], 1)
