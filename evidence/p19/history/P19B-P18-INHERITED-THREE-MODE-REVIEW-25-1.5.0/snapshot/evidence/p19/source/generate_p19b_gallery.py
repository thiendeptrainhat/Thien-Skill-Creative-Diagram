...
def main() -> None:
    ...
    if len(sources) != 30:
        raise RuntimeError("D-105 requires 25 canonical fixtures, four capability fixtures, one Layers variant, and the connector-policy-remediated UML model")
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097/D-098/D-099/D-100",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-105: all P-19 SVGs declare the centered/even straight-first connector policy; UML-class proves centered single ports, equal multi-port spacing, and one documented rounded-orthogonal exception; retained D-104–D-085 scope; 90 P-19 HTML, no owner approval or P-19C claim.",
    })
