...
PINS = {
    ...
    "evidence/p19/gallery/P-19B-MANIFEST.json": "f9d5ecb8a408bb677d92e27975a1ac0c8d6307ad813450f1156427d573912360",
    "evidence/p19/P-19B-SOURCE-MANIFEST.json": "2ddf2fdeeabb2b20727e49240ed03c783e28a4796695b77cd4c5ac8c4bc35776",
    "evidence/p19/P-19B-PLAN-MANIFEST.json": "d6d958c3a6a0ff4d753c6949ecebb7dc1832b44c74afd6f9bd9ca7cafb9afd35",
...
<h1>P-18 ↔ P-19<br>Toàn bộ diagram, cùng một trang.</h1>
    ...
    <p class="note">Theo D-084/D-085/D-095–D-105: <strong>giữ nguyên 14 bản P-18, bỏ các bản P-19 trùng loại, giữ mọi remediation trước và áp dụng connector policy căn giữa/chia đều/ưu tiên đường thẳng</strong>. P-19 có 25 loại + 4 capability + 1 presentation variant, mỗi identity đủ 3 mode; P-18 chỉ dùng neutral-light đã duyệt, không tự tạo thêm màu.</p>
...
<a href="{link(P18 / 'index.html')}" target="_blank" rel="noopener">Mở gallery P-18 ↗</a></div>
    <div><strong>P-19B · review-23 · Chờ owner review</strong><code>{html.escape(b['candidate_id'])}</code>
