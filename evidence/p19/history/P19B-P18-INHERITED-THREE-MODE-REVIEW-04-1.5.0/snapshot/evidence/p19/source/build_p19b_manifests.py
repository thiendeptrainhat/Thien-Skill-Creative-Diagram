...
CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-04-1.5.0"
...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-29",
        "boundary": "P-19B D-083 six-station shared-state flywheel remediation; owner visual review pending; P-19C not performed",
