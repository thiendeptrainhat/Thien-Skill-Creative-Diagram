...
**Phase đang thực hiện:** P-19B review-09 `in-progress`/owner-review-pending theo D-089, giữ scope D-084–D-088; exact review-08 archived; P-19 tổng thể `in-progress`; P-19C `not-started` và unauthorized
...
2. `P-19B` — remediation `in-progress` theo D-084–D-089: dùng trực tiếp 14 exact P-18R6 review-17 anchor, không tái sinh duplicate; 25 canonical type còn lại và bốn capability có ba mode, tổng 87 HTML/29 preview. Active review-09 giữ Fishbone D-086, dp-integration D-087 và bar-chart D-088, sửa riêng dp-security-matrix thành ma trận 5×5 với direct permission labels, role/component codes, một partner-BI Read boundary và exact table; giữ gallery/comparison đủ 101 diagram và không derive thêm màu P-18. Bảo toàn artwork P-19 ngoài dp-security-matrix/candidate metadata và giữ withdrawal custody để khôi phục.
