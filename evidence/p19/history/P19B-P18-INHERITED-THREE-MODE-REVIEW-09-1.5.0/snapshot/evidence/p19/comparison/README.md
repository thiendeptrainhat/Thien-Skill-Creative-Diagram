...
- Preserve: exact P-18R6 review-17 SVG bytes; all non-target P-19B review-07
  artwork, typography, colors, text, geometry and paint order. Review-08 changes
  only bar-chart relative to archived review-07; detailed Fishbone and
  dp-integration remain intact.
