# Handoff phiên mới — P-19B D-089 review-09 detailed dp-security-matrix; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-089.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-09-1.5.0` theo D-089, giữ scope D-084–D-088: 14 P-18 anchor + 87 P-19 HTML/29 preview. DP security matrix có 25 cell/5 role/5 component/1 focal partner-BI boundary; focused 82/82, scope 8/8, static 32/32 và regression 244/244 PASS. Browser `blocked / not executable`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-089; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086 khóa Fishbone, D-087 khóa dp-integration, D-088 khóa bar-chart và D-089 giới hạn review-09 ở dp-security-matrix
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-089 review-09 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
