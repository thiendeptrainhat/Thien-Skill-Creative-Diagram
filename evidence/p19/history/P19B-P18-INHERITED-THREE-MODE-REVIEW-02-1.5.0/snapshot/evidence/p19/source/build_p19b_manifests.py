...
CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-02-1.5.0"
...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-27",
        "boundary": "P-19B D-081 focused geometry remediation; owner visual review pending; P-19C not performed",
