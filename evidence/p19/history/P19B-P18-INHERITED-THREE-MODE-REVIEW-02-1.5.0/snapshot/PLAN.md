...
**Cập nhật:** 2026-08-27  
**Phạm vi được phép trong yêu cầu hiện tại:** D-081 authorize sửa riêng containment/centering của dp-integration và continuity của swimlane trong P-19B, kế thừa D-080; tạo review-02, tái sinh exact 129 HTML và trang đối chiếu, kiểm focused geometry/static/raster/regression; không mở P-19C hoặc package/release
**Phase đang thực hiện:** P-19B review-02 `in-progress`/owner-review-pending theo D-081; exact review-01 đã archive trước sửa hai lỗi owner báo; P-19 tổng thể `in-progress`; P-19C `not-started` và unauthorized
