...
**Cập nhật:** 2026-08-29  
**Phạm vi được phép trong yêu cầu hiện tại:** D-082 authorize Gantt-only review-03 và bộ dữ liệu minh họa đã được owner cho phép; tái sinh exact 129 HTML/trang đối chiếu, kiểm focused calendar/geometry/static/raster/regression; giữ các sửa lỗi D-081 và P-18 visual grammar; không mở P-19C hoặc package/release
**Phase đang thực hiện:** P-19B review-03 `in-progress`/owner-review-pending theo D-082; exact review-02 đã archive trước sửa Gantt; P-19 tổng thể `in-progress`; P-19C `not-started` và unauthorized
