...
**Ngày cập nhật candidate:** 2026-08-27  
...
- P-19 target tối thiểu 39 canonical type × ba mode đã khóa (`neutral-light`, `neutral-dark`, `editorial`) = 117 standalone HTML, cộng bốn capability mới × ba mode = 12 standalone HTML; tổng tối thiểu 129 specimen HTML, chưa tính `index.html`/contact sheet.
