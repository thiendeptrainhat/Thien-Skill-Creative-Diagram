...
**Cập nhật:** 2026-08-30  
**Phạm vi được phép trong yêu cầu hiện tại:** D-106: thay riêng P-19 `tree` bằng cây chi tiết ba tầng, kế thừa exact P-18 org-chart centered-span geometry; giữ D-105 global connector policy, 14 P-18 approved anchor, non-target artwork cùng mọi frozen/release bytes; cập nhật gallery/trang tổng hợp/evidence/handoff.
**Phase đang thực hiện:** P-19B review-26 `in-progress`/owner-review-pending theo D-106, giữ scope D-084–D-105; exact review-25 archived; P-19 tổng thể `in-progress`; P-19C `not-started` và unauthorized
...
2. `P-19B` — remediation `in-progress` theo D-084–D-106: dùng trực tiếp 14 exact P-18R6 review-17 anchor, không tái sinh duplicate; 25 canonical type, bốn capability và presentation variant `layers` có ba mode, tổng 90 HTML/30 preview. Active review-26 giữ toàn bộ D-086–D-105, thay riêng `tree` bằng detailed three-tier centered-span hierarchy kế thừa P-18 org-chart; comparison vẫn có 104 diagram, non-target artwork được bảo toàn và withdrawal custody vẫn khôi phục được.
...
**Verification dự kiến:** theo D-085/D-095–D-106, union 14 P-18 canonical + 25 P-19 canonical phải đúng 39 và không trùng; P-19 có 75 canonical + 12 capability + 3 `layers` variant HTML, 30 preview, đủ ba mode cho 30 identity. Đủ 90 SVG phải khai báo D-105; `uml-class` giữ exact centered/even/straight-first proof. `tree` phải có 9 node/8 relation/3 tầng, 14 straight connector primitive, root/4 parent đúng midpoint child span, một single-child direct line và geometry ba mode; mọi detailed artifact D-086–D-105 phải được giữ. P-18 phải giữ exact bytes/hash ở neutral-light, không claim ba-mode coverage cho 14 anchor này. Kiểm absence of withdrawn files, links, deterministic generation, retained artwork và recoverable custody; owner vẫn phải duyệt exact current gallery.
...
**Checkpoint D-109:** active candidate `P19B-P18-INHERITED-THREE-MODE-REVIEW-29-1.5.0`. Exact review-28 đã archive 477 files; protected corpus 11072 files khớp hash. `story-map` được thay riêng bằng bản đồ bốn activity/sáu backbone step/chín story/ba release slice, một labeled MVP cut và một high-risk story có dashed boundary + badge + table redundancy. Chỉ 3 target HTML + 1 preview đổi artwork; 87 non-target HTML giữ nguyên sau candidate normalization và 29 preview byte-identical. Geometry ba mode khớp; neutral-light proof 2000×1040 đã inspect. Focused 3/3, scope 8/8, static 34/34 và full regression 360/360 PASS. Verification/hash xem `evidence/p19/P-19B-REVIEW-29-VERIFICATION.json`; browser `BLOCKED_URL_POLICY`, owner approval pending, P-19C unauthorized, G-04 NOT-EVALUATED.
