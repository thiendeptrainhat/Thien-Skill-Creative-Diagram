#!/usr/bin/env python3
"""Preserve exact D-093 review-13 before Kanban review-14."""
import hashlib, json, shutil
from pathlib import Path

ROOT = Path(__file__).resolve().parents[3]
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-13-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        "candidate_id": "P19B-P18-INHERITED-THREE-MODE-REVIEW-13-1.5.0",
        "disposition": "historical before D-094 Kanban-only remediation; not owner approval",
        "manifest_pins": PINS,
