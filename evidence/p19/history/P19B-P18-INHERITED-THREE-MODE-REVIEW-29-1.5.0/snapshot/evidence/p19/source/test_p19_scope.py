...
from verify_p19b_review29 import verify
...
class ReuseScopeTests(unittest.TestCase):
    ...
    def test_exact_preservation_and_recoverable_withdrawal(self):
        ...
        self.assertEqual(report['story_map_measurement']['activities'], 4)
        self.assertEqual(report['story_map_measurement']['stories'], 9)
        self.assertEqual(report['story_map_measurement']['release_slices'], 3)
        self.assertEqual(report['story_map_measurement']['risk_stories'], 1)
