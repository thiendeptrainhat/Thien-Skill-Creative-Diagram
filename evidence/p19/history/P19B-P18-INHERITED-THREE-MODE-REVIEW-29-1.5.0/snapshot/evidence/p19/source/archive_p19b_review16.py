#!/usr/bin/env python3
"""Preserve exact D-096 review-16 before medallion review-17."""
import hashlib
import json
import shutil
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-16-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        "candidate_id": "P19B-P18-INHERITED-THREE-MODE-REVIEW-16-1.5.0",
        "disposition": "historical before D-097 medallion remediation; not owner approval",
        "manifest_pins": PINS,
