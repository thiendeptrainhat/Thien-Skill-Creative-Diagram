# Handoff phiên mới — P-19B D-088 review-08 detailed bar-chart; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-088.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-08-1.5.0` theo D-088, giữ scope D-084–D-087: 14 P-18 anchor + 87 P-19 HTML/29 preview. Bar chart có 8 bar/2 axis/6 tick/1 focal, zero-baseline 0–120; focused 75/75, scope 8/8, static 32/32 và regression 237/237 PASS. Browser `blocked / not executable`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-088; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086 khóa Fishbone, D-087 khóa dp-integration và D-088 giới hạn review-08 ở bar-chart
...
### D-088 checkpoint hiện hành

Exact review-07 đã archive byte-bound trước mutation. Active review-08 chỉ sửa bar-chart bằng dữ liệu minh họa độc lập: 8 sprint, one series, Y-domain 0–120, 6 tick, direct labels và một record-high Sprint 5 được encode dư thừa qua coral mark/label/legend/table. Archive 230 file và protected corpus 3553 file khớp; 84 non-target HTML giữ artwork ngoài candidate metadata, 28 preview byte-identical. Focused 75/75, scope 8/8, static 32/32, regression 237/237; ba Quick Look raster đã inspect. Xem `evidence/p19/P-19B-REVIEW-08-VERIFICATION.json`; owner approval pending, P-19C/G-04/package/release chưa được phép.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-088 review-08 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
