...
P19B_CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-28-1.5.0"
...
def validate_target_geometry(svg: str, diagram_type: str) -> dict[str, Any]:
    ...
    if diagram_type not in ("dp-integration", "swimlane", "bar-chart", "line-chart", "polar-chart", "wardley-map", "venn", "dp-security-matrix", "er-data-model", "high-level", "it-current-state", "kanban", "layer-stack", "medallion", "tree"):
        return {}
...
def render_gallery_html(ir_value: Mapping[str, Any], mode: str, fixture_id: str, *, connector_corner_style: str | None = None) -> str:
    ...
    detailed_types = ("gantt", "loop-flywheel", "dp-integration", "bar-chart", "line-chart", "polar-chart", "treemap", "wardley-map", "venn", "dp-security-matrix", "er-data-model", "uml-class", "high-level", "it-current-state", "kanban", "layer-stack", "medallion", "tree")
    detailed_ready = (
