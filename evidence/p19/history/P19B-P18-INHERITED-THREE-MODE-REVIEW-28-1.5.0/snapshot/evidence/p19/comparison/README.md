...
D-084/D-085/D-086/D-087/D-088/D-089/D-090/D-091/D-092/D-093/D-094/D-095/D-096/D-097/D-098/D-099/D-100/D-101/D-102/D-103/D-104.
...
- Preserve: exact P-18R6 review-17 SVG bytes and all non-target P-19B review-22
  artwork, typography, colors, text, geometry and paint order. Review-23 changes
  only the complete-border/uniform-gap geometry of the exact-area Treemap; Layers, the detailed line-chart, medallion, polar-chart, Wardley map, exact Venn and all retained
  diagrams remain intact.
- Display: 14 approved P-18 neutral-light originals + 90 P-19 specimens
  (25 canonical types + four capabilities + one presentation variant, each
  with three modes) = **104 diagrams**.
...
104 unique previews, complete P-19 modes, inert SVG, original links and source
