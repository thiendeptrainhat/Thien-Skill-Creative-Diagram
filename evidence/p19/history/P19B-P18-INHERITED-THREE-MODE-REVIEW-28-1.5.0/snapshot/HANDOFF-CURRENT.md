# Handoff phiên mới — P-19B D-108 review-28 ultra-thin centered tree; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-108.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-28-1.5.0` theo D-108, giữ scope D-084–D-107: 14 P-18 anchor + 90 P-19 HTML/30 preview. Tree giữ exact geometry D-106 nhưng dùng hệ nét ultra-thin: connector `1.0`, card `1.2`, root `1.6`, badge `0.9`, separator `1.0`, legend `1.2/1.6`. Exact review-27 đã archive 468 file; 10603 protected file khớp. Browser `BLOCKED_URL_POLICY`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
### D-108 checkpoint hiện hành

Exact review-27 đã archive byte-bound trước mutation: 468 snapshot file và 10603 protected file khớp. Active review-28 giảm toàn bộ hệ nét của `tree`: connector `1.0`, card `1.2`, root `1.6`, badge `0.9`, separator `1.0`, legend `1.2/1.6`. Toàn bộ 9 node/8 relation/3 tầng/14 straight primitive, tọa độ card/text/connector, centered-span fanout và geometry ba mode giữ nguyên review-27. 87 non-target HTML giữ artwork sau candidate normalization và 29 non-target preview byte-identical. Focused 6/6, scope 8/8, static 34/34 và regression 357/357 PASS. Xem `evidence/p19/P-19B-REVIEW-28-VERIFICATION.json`; owner approval pending, P-19C/G-04/package/release chưa được phép.
