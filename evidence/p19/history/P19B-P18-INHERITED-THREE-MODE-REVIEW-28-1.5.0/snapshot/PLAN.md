...
**Checkpoint D-108:** active candidate `P19B-P18-INHERITED-THREE-MODE-REVIEW-28-1.5.0`. Review-27 đã archive 468 files; protected corpus 10603 files khớp hash. Complete stroke system riêng tree giảm còn connector `1.0`, card `1.2`, root `1.6`, badge `0.9`, separator `1.0`, legend `1.2/1.6`; mọi emitted geometry element giữ nguyên review-27. 87 non-target HTML giữ nguyên sau candidate normalization, 29 preview byte-identical. Tree vẫn có 9 node/8 relation/3 tầng/14 straight primitive và exact centered-span geometry D-106. Focused tree 6/6, scope 8/8, static 34/34 và full regression 357/357 PASS. Verification/hash xem `evidence/p19/P-19B-REVIEW-28-VERIFICATION.json`; owner approval pending, P-19C unauthorized, G-04 NOT-EVALUATED.
