#!/usr/bin/env python3
"""Preserve exact D-111 review-31 before D-112 thin Treemap remediation."""
import hashlib
import json
import shutil
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-31-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        ...
        "disposition": "historical before D-112 thin Treemap remediation; not owner approval",
