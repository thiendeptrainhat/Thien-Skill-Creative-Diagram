"""Preserve the exact D-083 candidate before the owner-authorized D-084 change."""
import hashlib
import json
...
DEST = ROOT / 'evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-04-1.5.0'
PINS = {
...
def main():
    ...
    receipt = {'candidate_id': 'P19B-P18-INHERITED-THREE-MODE-REVIEW-04-1.5.0',
               'disposition': 'historical before D-084 approved Sankey adoption; not owner approval',
