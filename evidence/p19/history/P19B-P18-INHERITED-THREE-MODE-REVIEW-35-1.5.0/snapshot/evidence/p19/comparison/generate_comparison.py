...
PINS = {
    ...
    "evidence/p19/gallery/P-19B-MANIFEST.json": "8287bdea5101419bb109f43850d97e83abf24518ce6fdcbf6236cca3445f496b",
    "evidence/p19/P-19B-SOURCE-MANIFEST.json": "85d04c3249746d73c4217f791c60fddc09335eb9111da10632aadc6e2a50e9b9",
    "evidence/p19/P-19B-PLAN-MANIFEST.json": "9fb544a882705a0b59f1e63c8982a09d21f7ee976f88052dc8c2c4138216449f",
...
<h1>P-18 ↔ P-19<br>Toàn bộ diagram, cùng một trang.</h1>
    ...
    <p class="note">Theo D-084/D-085/D-095–D-115: <strong>giữ nguyên 14 bản P-18, bỏ các bản P-19 trùng loại, giữ mọi remediation trước và sửa radar thành bốn profile nét liền</strong>. P-19 có 25 loại + 4 capability + 2 presentation variant, mỗi identity đủ 3 mode; P-18 chỉ dùng neutral-light đã duyệt, không tự tạo thêm màu.</p>
...
<a href="{link(P18 / 'index.html')}" target="_blank" rel="noopener">Mở gallery P-18 ↗</a></div>
    <div><strong>P-19B · review-35 · Chờ owner review</strong><code>{html.escape(b['candidate_id'])}</code>
