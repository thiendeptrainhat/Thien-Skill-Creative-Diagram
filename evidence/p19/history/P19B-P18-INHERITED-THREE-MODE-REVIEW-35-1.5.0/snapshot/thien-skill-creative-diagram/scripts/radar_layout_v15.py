"""D-115 content-fit radar chart with five shared axes and four solid profiles."""
...
def render_radar(plan):
    ...
    parts = ['<g data-radar-contract="D-115-five-axis-four-solid-profile">']
    ...
    parts.append(_text(1894, 1000, "Màu + hình marker · tất cả nét liền", "rd-note", "end"))
    parts.append("</g>")
    return "".join(parts)
...
def radar_table(plan):
    ...
    return (
        ...
        '<p>Bốn hồ sơ dùng cùng năm tiêu chí và cùng miền tuyến tính 0–10. Hai mươi giá trị được lặp lại dưới dạng bảng; mọi profile dùng nét liền và được phân biệt bằng màu, hình marker cùng nhãn trực tiếp.</p>'
