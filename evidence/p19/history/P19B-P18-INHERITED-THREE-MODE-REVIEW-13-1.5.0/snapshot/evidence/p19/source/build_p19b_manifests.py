...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-29",
        "boundary": "P-19B D-093 it-current-state-only detailed current-state remediation retaining D-084–D-092 scope; P-18 rounded orthogonal connector policy; 14 approved P-18 anchors + 87 P-19 HTML; owner review pending; P-19C not performed",
