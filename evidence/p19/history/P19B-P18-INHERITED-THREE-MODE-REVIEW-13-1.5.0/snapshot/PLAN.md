...
**Phase đang thực hiện:** P-19B review-13 `in-progress`/owner-review-pending theo D-093, giữ scope D-084–D-092; exact review-12 archived; P-19 tổng thể `in-progress`; P-19C `not-started` và unauthorized
...
2. `P-19B` — remediation `in-progress` theo D-084–D-093: dùng trực tiếp 14 exact P-18R6 review-17 anchor, không tái sinh duplicate; 25 canonical type còn lại và bốn capability có ba mode, tổng 87 HTML/29 preview. Active review-13 giữ toàn bộ D-086–D-092 và thay riêng it-current-state bằng landscape hiện trạng ba miền chi tiết; connector orthogonal là một path liên tục, góc 90° bo tròn mặc định và thẳng chỉ khi khai báo. Giữ gallery/comparison đủ 101 diagram, không derive thêm màu P-18, bảo toàn artwork P-19 ngoài it-current-state/candidate metadata và giữ withdrawal custody để khôi phục.
