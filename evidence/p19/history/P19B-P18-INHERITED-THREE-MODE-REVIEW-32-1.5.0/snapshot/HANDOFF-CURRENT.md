# Handoff phiên mới — P-19B D-112 review-32 thin-stroke Treemap; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-112.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-32-1.5.0` theo D-112, giữ scope D-084–D-111: 14 P-18 anchor + 90 P-19 HTML/30 preview. `treemap` giữ exact D-101/D-103 geometry và giảm viền regular/focal còn `1.2/1.6`. Exact review-31 đã archive 513 file; 12542 protected file khớp. Browser `BLOCKED_URL_POLICY`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-112; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086–D-104 khóa các remediation/addition chi tiết, D-105 khóa global connector policy, D-106 khóa detailed centered-span tree, D-107/D-108 khóa stroke refinement, D-109 khóa detailed story map, D-110 khóa detailed state machine, D-111 khóa detailed sequence, D-112 khóa thin-stroke Treemap
