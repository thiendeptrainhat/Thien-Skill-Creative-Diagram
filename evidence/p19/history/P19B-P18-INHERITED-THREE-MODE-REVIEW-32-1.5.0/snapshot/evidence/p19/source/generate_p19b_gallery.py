...
def main() -> None:
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097/D-098/D-099/D-100/D-105/D-106/D-108/D-109/D-110/D-111/D-112",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-112: Treemap keeps the exact D-103 allocation geometry, complete four-edge borders and uniform 8-unit gaps while reducing regular/focal outline weights to 1.2/1.6 for the shared thin-stroke visual grammar; retained D-111–D-085 scope; 90 P-19 HTML, no owner approval or P-19C claim.",
    })
