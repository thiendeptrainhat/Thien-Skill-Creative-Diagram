...
from verify_p19b_review32 import verify
...
class ReuseScopeTests(unittest.TestCase):
    ...
    def test_exact_preservation_and_recoverable_withdrawal(self):
        ...
        self.assertEqual(report['treemap_measurement']['tiles'], 6)
        self.assertEqual(report['treemap_measurement']['complete_borders'], 6)
        self.assertEqual(report['treemap_measurement']['uniform_insets'], 6)
        self.assertEqual(report['stroke_contract']['regular_tile'], 1.2)
        self.assertEqual(report['stroke_contract']['focal_tile'], 1.6)
        self.assertEqual(report['old_current_geometry'], 'PASS')
