...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-112 Treemap-only thin-stroke remediation preserving exact D-103 allocation geometry, complete borders and uniform gaps, retaining D-085–D-111 scope; frozen P-17/P-19A/P-18 preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
