...
**Cập nhật:** 2026-08-30  
**Phạm vi được phép trong yêu cầu hiện tại:** D-112: giảm riêng paint weight viền P-19 `treemap`, giữ exact D-101 quantitative encoding và D-103 four-edge/inset/gap geometry; giữ 14 P-18 approved anchor, non-target artwork cùng mọi frozen/release bytes; cập nhật gallery/trang tổng hợp/evidence/handoff.
**Phase đang thực hiện:** P-19B review-32 `in-progress`/owner-review-pending theo D-112, giữ scope D-084–D-111; exact review-31 archived; P-19 tổng thể `in-progress`; P-19C `not-started` và unauthorized
...
2. `P-19B` — remediation `in-progress` theo D-084–D-112: dùng trực tiếp 14 exact P-18R6 review-17 anchor, không tái sinh duplicate; 25 canonical type, bốn capability và presentation variant `layers` có ba mode, tổng 90 HTML/30 preview. Active review-32 giữ toàn bộ remediation trước và chỉ giảm viền `treemap` về regular/focal `1.2/1.6`, giữ nguyên D-103 geometry; comparison vẫn có 104 diagram, non-target artwork được bảo toàn và withdrawal custody vẫn khôi phục được.
...
**Verification dự kiến:** theo D-085/D-095–D-112, union 14 P-18 canonical + 25 P-19 canonical phải đúng 39 và không trùng; P-19 có 75 canonical + 12 capability + 3 `layers` variant HTML, 30 preview, đủ ba mode cho 30 identity. Đủ 90 SVG phải khai báo D-105; mọi detailed artifact D-086–D-111 phải được giữ. Treemap phải giữ exact old/current geometry, sáu four-edge border, inset 4, gap 8 và chỉ dùng regular/focal stroke `1.2/1.6`. P-18 phải giữ exact bytes/hash ở neutral-light, không claim ba-mode coverage cho 14 anchor này. Kiểm absence of withdrawn files, links, deterministic generation, retained artwork và recoverable custody; owner vẫn phải duyệt exact current gallery.
...
**Checkpoint D-112:** active candidate `P19B-P18-INHERITED-THREE-MODE-REVIEW-32-1.5.0`. Exact review-31 đã archive 513 files; protected corpus 12542 files khớp hash. `treemap` chỉ giảm paint weight về regular/focal `1.2/1.6` cùng footer rule/swatch mảnh tương ứng; exact D-101/D-103 geometry, area, complete borders, inset/gap, labels và table giữ nguyên. Chỉ 3 target HTML + 1 preview đổi paint; 87 non-target HTML giữ nguyên sau candidate normalization và 29 preview byte-identical. Owner approval pending, P-19C unauthorized, G-04 NOT-EVALUATED.
