...
**Phase đang thực hiện:** P-19B review-11 `in-progress`/owner-review-pending theo D-091, giữ scope D-084–D-090; exact review-10 archived; P-19 tổng thể `in-progress`; P-19C `not-started` và unauthorized
...
2. `P-19B` — remediation `in-progress` theo D-084–D-091: dùng trực tiếp 14 exact P-18R6 review-17 anchor, không tái sinh duplicate; 25 canonical type còn lại và bốn capability có ba mode, tổng 87 HTML/29 preview. Active review-11 giữ toàn bộ D-090 ER model và sửa riêng sáu `1/N` theo đúng P-18 database-schema inline endpoint/knockout contract; giữ gallery/comparison đủ 101 diagram và không derive thêm màu P-18. Bảo toàn artwork P-19 ngoài er-data-model/candidate metadata và giữ withdrawal custody để khôi phục.
