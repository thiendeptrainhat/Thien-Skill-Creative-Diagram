...
def main() -> None:
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-091: er-data-model inline-cardinality-only remediation matching the approved P-18 database-schema endpoint/knockout contract; retaining D-090 entity model and D-089–D-085 scope; 87 P-19 HTML, no owner approval or P-19C claim.",
    })
