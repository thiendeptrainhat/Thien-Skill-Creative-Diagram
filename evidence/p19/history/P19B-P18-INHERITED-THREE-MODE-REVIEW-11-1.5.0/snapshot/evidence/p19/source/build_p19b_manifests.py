...
CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-11-1.5.0"
...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-29",
        "boundary": "P-19B D-091 er-data-model inline-cardinality-only remediation retaining D-084–D-090 scope; 14 approved P-18 anchors + 87 P-19 HTML; owner review pending; P-19C not performed",
