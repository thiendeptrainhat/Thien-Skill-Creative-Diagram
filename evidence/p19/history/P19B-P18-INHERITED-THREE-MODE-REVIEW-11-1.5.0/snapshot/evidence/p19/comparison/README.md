...
D-084/D-085/D-086/D-087/D-088/D-089/D-090/D-091.
...
- Preserve: exact P-18R6 review-17 SVG bytes and all non-target P-19B review-10
  artwork, typography, colors, text, geometry and paint order. Review-11 changes
  only six er-data-model cardinality placements relative to archived review-10;
  all retained detailed diagrams remain intact.
