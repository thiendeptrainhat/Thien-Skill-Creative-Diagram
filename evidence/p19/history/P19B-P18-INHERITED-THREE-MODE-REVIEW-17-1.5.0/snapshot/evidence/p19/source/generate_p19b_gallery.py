...
def main() -> None:
    ...
    if len(sources) != 30:
        raise RuntimeError("D-097 requires 25 canonical fixtures, four capability fixtures, one Layers variant, and the detailed medallion lifecycle")
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-097: remediated medallion as an original five-stage lifecycle with four directed promotions and two processing paths; retained D-096–D-085 scope; 90 P-19 HTML, no owner approval or P-19C claim.",
    })
