...
CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-17-1.5.0"
...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-097 detailed medallion retaining D-084–D-096 scope; five stages/four directed promotions/two processing paths/focal plus archive non-color redundancy; frozen P-17/P-19A preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
