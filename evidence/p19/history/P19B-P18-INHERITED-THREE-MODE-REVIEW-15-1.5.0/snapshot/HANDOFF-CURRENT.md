# Handoff phiên mới — P-19B D-095 review-15 Layers addition; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-095.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-15-1.5.0` theo D-095, giữ scope D-084–D-094: 14 P-18 anchor + 90 P-19 HTML/30 preview. `layers` là presentation variant dưới `layer-stack`, có 5 dải L5→L1, abstraction axis và một focal layer có non-color label/note. Exact review-14 đã archive; 87 prior HTML/29 preview được bảo toàn. Focused 124/124, scope 8/8, static 34/34 và regression 286/286 PASS. Browser `blocked / not executable`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-095; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086–D-094 khóa các remediation chi tiết và D-095 bổ sung presentation variant `layers`
...
- P-17 semantic source vẫn đủ 39 type + bốn capability; P-19A registry không đổi. Gallery hiện hành giữ trực tiếp 14 P-18 anchor ở neutral-light, sinh 87 HTML P-19 theo D-085 và bổ sung ba-mode presentation identity `layers` theo D-095: tổng 90 HTML P-19 cho 30 identity; owner approval pending.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-095 review-15 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
