...
- Theo D-095, bổ sung presentation identity `layers` kế thừa semantic parent `layer-stack` ở đủ ba mode; tổng 90 P-19 specimen HTML + 14 P-18 anchor = 104 diagram tổng hợp; không tính index/contact sheet;
