...
def main() -> None:
    ...
    if len(sources) != 30:
        raise RuntimeError("D-095 requires 25 canonical fixtures, four capability fixtures, and one Layers presentation variant")
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-095: added an original five-band Layers presentation variant under canonical parent layer-stack; retained D-094–D-085 scope; 90 P-19 HTML, no owner approval or P-19C claim.",
    })
