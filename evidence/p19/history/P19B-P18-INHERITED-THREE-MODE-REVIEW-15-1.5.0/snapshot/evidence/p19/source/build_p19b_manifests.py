...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-29",
        "boundary": "P-19B D-095 Layers presentation-variant addition retaining D-084–D-094 scope; five bands/one abstraction axis/one redundantly encoded focal layer; frozen P-17/P-19A preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
