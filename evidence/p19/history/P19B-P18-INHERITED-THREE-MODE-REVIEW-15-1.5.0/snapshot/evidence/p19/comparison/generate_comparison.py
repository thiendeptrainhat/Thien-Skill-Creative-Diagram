...
PINS = {
    ...
    "evidence/p19/gallery/P-19B-MANIFEST.json": "ed0ce516a20ad7d7ac62a5cec34a22a602f0e4d2fb0c933a53725862999ce2db",
    "evidence/p19/P-19B-SOURCE-MANIFEST.json": "b98a5e9cd58c70d1396acb1c951d060e9e30de006dd88a72ff7dbef2437b941c",
    "evidence/p19/P-19B-PLAN-MANIFEST.json": "7d4a73025a0fd26faf9c42e0e309f8d9a3df1f8bf58db8acdf1a33396266c1c4",
...
<h1>P-18 ↔ P-19<br>Toàn bộ diagram, cùng một trang.</h1>
    ...
    <p class="note">Theo D-084/D-085/D-095: <strong>giữ nguyên 14 bản P-18, bỏ các bản P-19 trùng loại và bổ sung layers dưới canonical parent layer-stack</strong>. P-19 có 25 loại + 4 capability + 1 presentation variant, mỗi identity đủ 3 mode; P-18 chỉ dùng neutral-light đã duyệt, không tự tạo thêm màu.</p>
...
<a href="{link(P18 / 'index.html')}" target="_blank" rel="noopener">Mở gallery P-18 ↗</a></div>
    <div><strong>P-19B · review-15 · Chờ owner review</strong><code>{html.escape(b['candidate_id'])}</code>
