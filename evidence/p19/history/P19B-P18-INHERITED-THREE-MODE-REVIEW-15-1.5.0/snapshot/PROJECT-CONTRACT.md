...
- Gallery hiện hành theo D-084–D-095 dùng trực tiếp 14 anchor P-18 review-17 đã duyệt ở `neutral-light`, không tạo P-19 trùng loại. P-19 sinh 25 canonical type × ba mode = 75 HTML, bốn capability × ba mode = 12 HTML và presentation variant `layers` của canonical parent `layer-stack` × ba mode = 3 HTML, tổng 90 specimen; trang tổng hợp có 14 + 90 = 104 diagram. D-086–D-094 giữ các remediation chi tiết; D-095 bổ sung riêng `layers` mà không sửa taxonomy/semantic grammar/P-19A frozen. Yêu cầu 129 HTML P-19 trước đây là historical; taxonomy/semantic source vẫn 39 type + bốn capability.
