...
PINS = {
    ...
    "evidence/p19/gallery/P-19B-MANIFEST.json": "36ab7a7e3d21820ef6a11ec92ff4bb52f13eaf7a2b22d2ba3cb05ca2f6f35a7f",
    "evidence/p19/P-19B-SOURCE-MANIFEST.json": "8eea5f61dab2fc12f2a04f9a0ba82f4869c952797782f7f95079d76861681cba",
    "evidence/p19/P-19B-PLAN-MANIFEST.json": "55b079188820c217ab1e2d548fb69ab86e78087197fc4f99db068f2ac7ca01bb",
...
<h1>P-18 ↔ P-19<br>Toàn bộ diagram, cùng một trang.</h1>
    ...
    <p class="note">Theo D-084/D-085/D-095/D-096: <strong>giữ nguyên 14 bản P-18, bỏ các bản P-19 trùng loại, giữ layers và thay riêng detailed line-chart</strong>. P-19 có 25 loại + 4 capability + 1 presentation variant, mỗi identity đủ 3 mode; P-18 chỉ dùng neutral-light đã duyệt, không tự tạo thêm màu.</p>
...
<a href="{link(P18 / 'index.html')}" target="_blank" rel="noopener">Mở gallery P-18 ↗</a></div>
    <div><strong>P-19B · review-16 · Chờ owner review</strong><code>{html.escape(b['candidate_id'])}</code>
