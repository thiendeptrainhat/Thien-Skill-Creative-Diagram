...
def main() -> None:
    ...
    if len(sources) != 30:
        raise RuntimeError("D-095/D-096 require 25 canonical fixtures, four capability fixtures, one Layers variant and the detailed line chart")
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-096: remediated line-chart as an original three-series, eight-week exact quantitative view; retained D-095–D-085 scope; 90 P-19 HTML, no owner approval or P-19C claim.",
    })
