...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-096 detailed line-chart retaining D-084–D-095 scope; three series/eight weeks/24 points/arrow-free axes/non-color redundancy; frozen P-17/P-19A preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
