# Handoff phiên mới — P-19B D-096 review-16 detailed line-chart; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-096.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-16-1.5.0` theo D-096, giữ scope D-084–D-095: 14 P-18 anchor + 90 P-19 HTML/30 preview. `line-chart` có 3 series × 8 tuần/24 điểm, 2 arrow-free axis, 6 tick, focal area và non-color dash/marker redundancy. Exact review-15 đã archive; 87 non-target HTML/29 non-target preview được bảo toàn. Focused 132/132, scope 8/8, static 34/34 và regression 294/294 PASS. Browser `blocked / not executable`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-096; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086–D-095 khóa các remediation/addition chi tiết và D-096 khóa detailed `line-chart`
...
- P-17 semantic source vẫn đủ 39 type + bốn capability; P-19A registry không đổi. Gallery hiện hành giữ trực tiếp 14 P-18 anchor ở neutral-light, sinh 87 HTML P-19 theo D-085, bổ sung ba-mode presentation identity `layers` theo D-095 và thay riêng detailed `line-chart` theo D-096: tổng 90 HTML P-19 cho 30 identity; owner approval pending.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-096 review-16 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
