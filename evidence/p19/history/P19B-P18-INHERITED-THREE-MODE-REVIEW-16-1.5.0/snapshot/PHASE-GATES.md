...
- Theo D-095/D-096, giữ presentation identity `layers` kế thừa semantic parent `layer-stack` ở đủ ba mode và detailed three-series `line-chart`; tổng 90 P-19 specimen HTML + 14 P-18 anchor = 104 diagram tổng hợp; không tính index/contact sheet;
