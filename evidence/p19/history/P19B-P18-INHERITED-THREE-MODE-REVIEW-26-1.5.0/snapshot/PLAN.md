...
**Checkpoint D-106:** active candidate `P19B-P18-INHERITED-THREE-MODE-REVIEW-26-1.5.0`. Review-25 đã archive 448 files; protected corpus 9694 files khớp hash. Chỉ 3 tree HTML và một preview đổi artwork; 87 non-target HTML giữ nguyên sau candidate normalization, 29 preview byte-identical. Tree có 9 node/8 relation/3 tầng/14 straight connector primitive; root và bốn parent đúng midpoint child span, branch interval `640/640`, two-child offset `−150/+150`, single-child direct centered. Focused tree 5/5, scope 8/8, static 34/34 và full regression 356/356 PASS. Verification/hash xem `evidence/p19/P-19B-REVIEW-26-VERIFICATION.json`; owner approval pending, P-19C unauthorized, G-04 NOT-EVALUATED.
