# Handoff phiên mới — P-19B D-106 review-26 centered three-tier tree; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-106.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-26-1.5.0` theo D-106, giữ scope D-084–D-105: 14 P-18 anchor + 90 P-19 HTML/30 preview. Tree mới có 9 node/8 relation/3 tầng/14 straight connector primitive; root và mọi parent nằm đúng midpoint child span, sibling phân bố cân đối, single-child đi thẳng tâm. Exact review-25 đã archive 448 file; 9694 protected file khớp. Focused D-106 và preservation verification PASS; browser `BLOCKED_URL_POLICY`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-106; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086–D-104 khóa các remediation/addition chi tiết, D-105 khóa global connector policy và D-106 khóa detailed centered-span tree
...
### D-106 checkpoint hiện hành

Exact review-25 đã archive byte-bound trước mutation: 448 snapshot file và 9694 protected file khớp. Active review-26 chỉ thay `tree` bằng hierarchy ba tầng độc lập: 1 root, 3 branch, 5 leaf và 8 parent relation. Root `x=1000` nằm giữa branch span `360..1640`; branch interval `640/640`; hai group hai-child dùng offset `−150/+150`; nhánh một child dùng direct centered line tại `x=1640`. Multi-child fanout kế thừa P-18 org-chart bằng centered trunk + shared bus + centered drops; tổng 14 straight line primitive, không arrowhead/curve. 87 non-target HTML giữ artwork sau candidate normalization và 29 non-target preview byte-identical; geometry ba mode khớp. Focused tree 5/5, scope 8/8, static 34/34 và full regression 356/356 PASS. Xem `evidence/p19/P-19B-REVIEW-26-VERIFICATION.json`; owner approval pending, P-19C/G-04/package/release chưa được phép.
...
- P-17 semantic source vẫn đủ 39 type + bốn capability; P-19A registry không đổi. Gallery hiện hành giữ trực tiếp 14 P-18 anchor ở neutral-light, sinh 90 HTML P-19/30 identity theo D-085/D-095–D-106, áp dụng global connector policy D-105 và detailed centered-span tree D-106; owner approval pending.
...
- Active P-19B review-26: detailed tree verification PASS với 9 node/8 relation/3 tầng/14 straight primitive, 4 centered parent-span proof và geometry ba mode; focused tree 5/5, scope 8/8, static 34/34, regression 356/356 PASS; 87 non-target HTML giữ artwork, 29 non-target preview byte-identical và exact P-18 anchors giữ nguyên. Local neutral-light raster đã inspect; browser bị URL policy chặn, không thay browser/full visual PASS và không mở P-19C.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-106 review-26 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
