"""D-103 uniformly inset exact-area continent Treemap with complete borders."""
...
def render_treemap(plan):
    ...
    parts = [f'<g data-treemap-contract="D-103-uniform-inset-complete-borders" data-inter-tile-gap="{INTER_TILE_GAP:.1f}">']
