# Handoff phiên mới — P-19B D-084/D-085 review-05 reuse P-18; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-085.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-05-1.5.0` theo D-084/D-085: giữ 14 P-18 anchor, P-19 còn 87 HTML/29 preview; static 32/32 và scope tests 8/8 PASS. Browser `blocked / not executable`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-085; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B và D-080 khóa owner rejection cùng P-18-inherited remediation successor
...
### D-084/D-085 checkpoint hiện hành
...
- Active P-19B review-05: static 32/32, scope tests 8/8; 87 retained HTML chỉ đổi candidate ID, 29 preview byte-identical, exact P-18 anchors giữ nguyên. Không tạo/raster artwork mới; không carry forward broad visual/browser PASS, không mở P-19C.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-084/D-085 review-05 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
