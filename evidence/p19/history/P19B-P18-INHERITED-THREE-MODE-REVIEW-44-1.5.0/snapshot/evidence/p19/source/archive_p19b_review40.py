#!/usr/bin/env python3
"""Preserve exact D-120 review-40 before D-121 slope-graph remediation."""
import hashlib
import json
import shutil
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-40-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        ...
        "disposition": "historical before D-121 slope-graph display rename and detailed two-state redraw; not owner approval",
        "manifest_pins": PINS,
