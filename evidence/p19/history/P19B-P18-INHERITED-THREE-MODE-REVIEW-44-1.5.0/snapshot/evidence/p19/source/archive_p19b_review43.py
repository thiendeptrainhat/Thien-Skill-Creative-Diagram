#!/usr/bin/env python3
"""Preserve exact D-123 review-43 before D-124 layer-stack remediation."""
import hashlib
import json
import shutil
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-43-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        ...
        "disposition": "historical before D-124 detailed layer-stack redraw; not owner approval",
        "manifest_pins": PINS,
