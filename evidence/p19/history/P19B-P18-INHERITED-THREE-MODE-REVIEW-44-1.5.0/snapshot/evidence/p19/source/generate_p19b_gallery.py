...
def specimen_sources() -> list[tuple[str, str, dict]]:
    ...
    canonical['layer-stack'] = layer_stack_fixture()
    ...
    variants["CAP-V19"] = ridgeline_fixture()
...
def main() -> None:
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097/D-098/D-099/D-100/D-105/D-106/D-108/D-109/D-110/D-111/D-112/D-113/D-114/D-115/D-116/D-117/D-118/D-119/D-120/D-121/D-122/D-123/D-124",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-124: replaced only the three canonical layer-stack modes with an original five-layer enterprise AI platform stack using the inherited P-18 template, 22 owned modules, two split intelligence domains, four straight centered dependency handoffs, one focal orchestration layer and an exact module table; retained D-123–D-085 scope including the separate layers presentation variant; 93 P-19 HTML, no owner approval or P-19C claim.",
    })
