# Handoff phiên mới — P-19B D-124 review-44 layer-stack; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-124.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-44-1.5.0` theo D-124, giữ scope D-084–D-123: 14 P-18 anchor + 93 P-19 HTML/31 preview. Review-44 thay riêng canonical `layer-stack` bằng 5 tầng/23 module/2 miền con/4 dependency thẳng căn giữa/1 focal layer/1 abstraction axis; template hiện tại và presentation variant `layers` giữ nguyên. 90 non-target HTML/30 preview được bảo toàn. Exact review-43 đã archive 635 file; 19382 protected file khớp. Owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-124; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-105 khóa global connector policy, D-113 khóa scatter-chart, D-114 khóa detailed radar, D-115 khóa solid-line radar, D-116 khóa marker-free radar plot, D-117 khóa detailed five-shape process, D-118 khóa continuous document connectors, D-119 khóa thin-stroke process, D-120 khóa Bubble identity/chart, D-121 khóa slope-graph identity/chart, D-122 khóa dumbbell identity/chart, D-123 khóa ridgeline identity/chart và D-124 khóa detailed layer-stack
...
### D-124 checkpoint hiện hành

Exact review-43 đã archive byte-bound trước mutation: 635 snapshot file và 19382 protected file khớp. Active review-44 thay riêng canonical `layer-stack` bằng đúng 5 tầng, 23 module phân phối `4/5/6/4/4`, 2 miền con cân bằng ở L3, 4 dependency thẳng căn giữa, 1 focal layer, 1 focal module và 1 abstraction axis; exact 23-row table dùng cùng source. Ba mode cùng geometry; neutral-light raster 2000×1250 đã inspect. Focused 36/36, static 34/34, full regression 410/410 và exact verifier PASS; owner approval pending; P-19C/G-04/package/release chưa được phép.
