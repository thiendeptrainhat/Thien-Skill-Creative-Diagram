...
P19B_CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-42-1.5.0"
...
def render_gallery_html(ir_value: Mapping[str, Any], mode: str, fixture_id: str, *, connector_corner_style: str | None = None) -> str:
    ...
    identity = "layers" if is_layers_variant else "scatter-chart" if is_scatter_variant else "dumbbell" if adapter["capability_id"] == "CAP-V17" else "slope-graph" if adapter["capability_id"] == "CAP-V18" else "bubble" if adapter["capability_id"] == "CAP-V20" else adapter["capability_id"] or adapter["canonical_type"]
    ...
    detailed_ready = (
        ...
        and (adapter["canonical_type"] != "line-chart" or is_detailed_line_chart(plan) or is_detailed_slope_graph(plan))
