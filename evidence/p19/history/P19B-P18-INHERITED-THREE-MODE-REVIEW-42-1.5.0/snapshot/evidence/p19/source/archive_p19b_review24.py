#!/usr/bin/env python3
"""Preserve exact D-104 review-24 before connector-policy review-25."""
import hashlib
import json
import shutil
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-24-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        ...
        "disposition": "historical before D-105 global connector-policy remediation; not owner approval",
        "manifest_pins": PINS,
