...
CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-30-1.5.0"
...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-110 detailed state machine with one initial marker, four stable states, one terminal marker, five straight transitions and one rounded return transition, retaining D-085–D-109 scope; frozen P-17/P-19A preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
