...
def main() -> None:
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097/D-098/D-099/D-100/D-105/D-106/D-108/D-109/D-110",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-110: state-machine is a detailed lifecycle with one initial marker, four stable states, one terminal marker, five straight transitions and one rounded-orthogonal dashed return transition; independently reimplemented from the owner structural rubric in P-18 review-17 visual grammar; retained D-109–D-085 scope; 90 P-19 HTML, no owner approval or P-19C claim.",
    })
