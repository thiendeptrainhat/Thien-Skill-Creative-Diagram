...
PINS = {
    ...
    "evidence/p19/gallery/P-19B-MANIFEST.json": "89965bb94d597ec54148cc0c98481fc69898ca516ade69ef11ea861835a8fbbf",
    "evidence/p19/P-19B-SOURCE-MANIFEST.json": "41d556bf57c5122ab3df70bf2fdb132448ca4b752bd9f831826c7b6ae2ee37cd",
    "evidence/p19/P-19B-PLAN-MANIFEST.json": "2358682fc847e35b6bc3ab5d3cfa2c09d62c9ef1a6adf249863c64fd9f388fe8",
...
<h1>P-18 ↔ P-19<br>Toàn bộ diagram, cùng một trang.</h1>
    ...
    <p class="note">Theo D-084/D-085/D-095–D-110: <strong>giữ nguyên 14 bản P-18, bỏ các bản P-19 trùng loại, giữ mọi remediation trước, áp dụng connector policy căn giữa/chia đều/ưu tiên đường thẳng và dùng state-machine chi tiết với return route bo góc có lý do</strong>. P-19 có 25 loại + 4 capability + 1 presentation variant, mỗi identity đủ 3 mode; P-18 chỉ dùng neutral-light đã duyệt, không tự tạo thêm màu.</p>
...
<a href="{link(P18 / 'index.html')}" target="_blank" rel="noopener">Mở gallery P-18 ↗</a></div>
    <div><strong>P-19B · review-30 · Chờ owner review</strong><code>{html.escape(b['candidate_id'])}</code>
