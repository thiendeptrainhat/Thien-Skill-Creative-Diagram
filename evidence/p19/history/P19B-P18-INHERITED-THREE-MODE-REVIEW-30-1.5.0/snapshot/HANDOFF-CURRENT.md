# Handoff phiên mới — P-19B D-110 review-30 detailed state machine; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-110.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-30-1.5.0` theo D-110, giữ scope D-084–D-109: 14 P-18 anchor + 90 P-19 HTML/30 preview. `state-machine` có 1 initial marker, 4 stable state, 1 terminal marker, 5 straight transition và 1 rounded return transition; đủ 12 centered attachment. Exact review-29 đã archive 489 file; 11550 protected file khớp. Browser `BLOCKED_URL_POLICY`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
