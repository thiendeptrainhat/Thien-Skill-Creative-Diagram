...
CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-31-1.5.0"
...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-111 detailed sequence with four centered participants/lifelines, two activations, five straight cross-participant messages and one rounded self-call exception, retaining D-085–D-110 scope; frozen P-17/P-19A preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
