...
PINS = {
    ...
    "evidence/p19/gallery/P-19B-MANIFEST.json": "8d27b7a6b75094384d0501d4fb48c5487084a7fb344a655bbeba1398aff30eda",
    "evidence/p19/P-19B-SOURCE-MANIFEST.json": "ffeaf7a03abf600c2c8548dd52ec504bab4df1e9136c07424e844d357fbcbe50",
    "evidence/p19/P-19B-PLAN-MANIFEST.json": "e21a9573ba6d2efcb8635a26039972db3e68cc306882804c3d9d2ee26a88f2f7",
...
<h1>P-18 ↔ P-19<br>Toàn bộ diagram, cùng một trang.</h1>
    ...
    <p class="note">Theo D-084/D-085/D-095–D-111: <strong>giữ nguyên 14 bản P-18, bỏ các bản P-19 trùng loại, giữ mọi remediation trước, áp dụng connector policy căn giữa/chia đều/ưu tiên đường thẳng và dùng sequence chi tiết với bốn lifeline, hai activation cùng một self-call bo góc có lý do</strong>. P-19 có 25 loại + 4 capability + 1 presentation variant, mỗi identity đủ 3 mode; P-18 chỉ dùng neutral-light đã duyệt, không tự tạo thêm màu.</p>
...
<a href="{link(P18 / 'index.html')}" target="_blank" rel="noopener">Mở gallery P-18 ↗</a></div>
    <div><strong>P-19B · review-31 · Chờ owner review</strong><code>{html.escape(b['candidate_id'])}</code>
