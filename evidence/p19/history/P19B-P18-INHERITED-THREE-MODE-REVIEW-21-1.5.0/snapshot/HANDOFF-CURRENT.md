# Handoff phiên mới — P-19B D-101 review-21 exact-area Treemap; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-101.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-21-1.5.0` theo D-101, giữ scope D-084–D-100: 14 P-18 anchor + 90 P-19 HTML/30 preview. `treemap` có 6 leaf/6 exact-area tile, exact parent total, một focal tile, một compact-label tile và exact value table. Exact review-20 đã archive; 87 non-target HTML/29 non-target preview được bảo toàn. Focused 174/174, scope 8/8, static 34/34 và regression 336/336 PASS; browser `BLOCKED_URL_POLICY`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-101; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086–D-100 khóa các remediation/addition chi tiết và D-101 khóa exact-area `treemap`
...
### D-101 checkpoint hiện hành

Exact review-20 đã archive byte-bound trước mutation. Active review-21 chỉ thay `treemap`: sáu leaf/rectangle có area share bằng value share, exact hierarchy total, một focal tile Châu Á, một compact-label tile Châu Đại Dương, năm direct label cùng legend và exact table. Archive 398 file và protected corpus 7594 file khớp; 87 non-target HTML giữ artwork sau candidate-ID normalization, 29 non-target preview byte-identical; tổng vẫn 90 P-19 HTML/30 preview và comparison có 104 diagram. Focused 174/174, scope 8/8, static 34/34 và regression 336/336 PASS; neutral-light Quick Look raster đã inspect. In-app browser từ chối local file URL theo policy nên browser là `BLOCKED_URL_POLICY`, không bypass. Xem `evidence/p19/P-19B-REVIEW-21-VERIFICATION.json`; owner approval pending, P-19C/G-04/package/release chưa được phép.
...
- Active P-19B review-21: focused 174/174, scope 8/8, static 34/34 và regression 336/336 PASS; Treemap 6 leaf/6 exact-area tile, exact total, một focal và một compact-label tile cùng geometry qua ba mode; 87 non-target HTML giữ artwork, 29 preview byte-identical và exact P-18 anchors giữ nguyên. Quick Look chỉ là focused local raster, browser bị URL policy chặn; không thay browser/full visual PASS và không mở P-19C.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-101 review-21 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
