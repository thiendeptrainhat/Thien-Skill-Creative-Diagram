...
PINS = {
    ...
    "evidence/p19/gallery/P-19B-MANIFEST.json": "38a8b1524761a095cf6303cbb8fdb06f31bbfc34dcd826b1b9210a6722c42946",
    "evidence/p19/P-19B-SOURCE-MANIFEST.json": "febd78e83ecac917f1270ae7eaae5b2161cfbf99d5ef9981a3d815d569ed8e0b",
    "evidence/p19/P-19B-PLAN-MANIFEST.json": "bb5cd948cb55eb4aa4159829ab045351ea63d14b49a7080ffc036c7080eaefcb",
...
<h1>P-18 ↔ P-19<br>Toàn bộ diagram, cùng một trang.</h1>
    ...
    <p class="note">Theo D-084/D-085/D-095–D-101: <strong>giữ nguyên 14 bản P-18, bỏ các bản P-19 trùng loại, giữ layers, detailed line-chart, medallion, polar-chart, wardley-map và exact venn, thay riêng exact-area treemap</strong>. P-19 có 25 loại + 4 capability + 1 presentation variant, mỗi identity đủ 3 mode; P-18 chỉ dùng neutral-light đã duyệt, không tự tạo thêm màu.</p>
...
<a href="{link(P18 / 'index.html')}" target="_blank" rel="noopener">Mở gallery P-18 ↗</a></div>
    <div><strong>P-19B · review-21 · Chờ owner review</strong><code>{html.escape(b['candidate_id'])}</code>
