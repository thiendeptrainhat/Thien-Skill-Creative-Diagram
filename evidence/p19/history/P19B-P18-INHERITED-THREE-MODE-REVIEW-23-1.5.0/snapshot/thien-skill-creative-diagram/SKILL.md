...
The common request/router/IR core and semantic validators cover 39 canonical types plus the four P-17 variants. P-19A retains deterministic adapters for all 39+4. The QA gallery now reuses 14 approved P-18 review-17 originals and contains 90 P-19 HTML specimens across 25 canonical identities, four capabilities and the `layers` presentation variant; see [visual coverage](references/visual-coverage.md) for the selection boundary. Gallery selection does not remove semantic capabilities. Current authorization/status belongs to the project governance, not this skill entrypoint. Do not claim P-19C, G-04@1.5.0, owner approval, package or release readiness. Historical P-07/P-08 remains the released v1.0.0 path; `CAP-V15` remains a text-equivalent fallback.
