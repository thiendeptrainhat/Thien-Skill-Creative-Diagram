# Handoff phiên mới — P-19B D-103 review-23 complete-border uniformly spaced Treemap; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-103.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-23-1.5.0` theo D-103, giữ scope D-084–D-102: 14 P-18 anchor + 90 P-19 HTML/30 preview. `treemap` giữ 6 leaf/6 exact allocation-area tile; mỗi visible tile inset đều 4 unit nên đủ bốn cạnh viền và mọi shared boundary có gap thật 8 unit. Exact review-22 đã archive; 87 non-target HTML/29 non-target preview được bảo toàn. Focused 176/176, scope 8/8, static 34/34 và regression 338/338 PASS; browser `BLOCKED_URL_POLICY`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-103; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086–D-102 khóa các remediation/addition chi tiết và D-103 khóa complete border/uniform real gap cho exact-area `treemap`
...
### D-103 checkpoint hiện hành

Exact review-22 đã archive byte-bound trước mutation. Active review-23 retire under-stroke và inset mỗi visible `treemap` rectangle 4 unit khỏi exact allocation rectangle ở cả bốn cạnh; nhờ vậy cả sáu tile có complete outline riêng và mọi shared boundary có gap thật 8 unit đồng đều. Archive 419 file và protected corpus 8404 file khớp; 87 non-target HTML giữ artwork sau candidate-ID normalization, 29 non-target preview byte-identical; tổng vẫn 90 P-19 HTML/30 preview và comparison có 104 diagram. Focused 176/176, scope 8/8, static 34/34 và regression 338/338 PASS; neutral-light Quick Look raster đã inspect. In-app browser từ chối local file URL theo policy nên browser là `BLOCKED_URL_POLICY`, không bypass. Xem `evidence/p19/P-19B-REVIEW-23-VERIFICATION.json`; owner approval pending, P-19C/G-04/package/release chưa được phép.
...
- P-17 semantic source vẫn đủ 39 type + bốn capability; P-19A registry không đổi. Gallery hiện hành giữ trực tiếp 14 P-18 anchor ở neutral-light, sinh 87 HTML P-19 theo D-085, bổ sung ba-mode presentation identity `layers` theo D-095, detailed `line-chart` theo D-096, detailed `medallion` theo D-097, detailed `polar-chart` theo D-098, detailed `wardley-map` theo D-099, exact three-set `venn` theo D-100, exact-area `treemap` theo D-101, visible border theo D-102 và complete four-edge/uniform real gap theo D-103: tổng 90 HTML P-19 cho 30 identity; owner approval pending.
...
- Active P-19B review-23: focused 176/176, scope 8/8, static 34/34 và regression 338/338 PASS; Treemap 6 leaf/6 exact allocation-area tile, 6 complete four-edge outline, 6 uniform inset và real gap 8 unit, exact total, một focal và một compact-label tile cùng geometry qua ba mode; 87 non-target HTML giữ artwork, 29 preview byte-identical và exact P-18 anchors giữ nguyên. Quick Look chỉ là focused local raster, browser bị URL policy chặn; không thay browser/full visual PASS và không mở P-19C.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-103 review-23 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
