...
from verify_p19b_review23 import verify
...
class ReuseScopeTests(unittest.TestCase):
    ...
    def test_exact_preservation_and_recoverable_withdrawal(self):
        ...
        self.assertEqual(report['treemap_html_changed'], 3)
        self.assertEqual(report['prior_html_artwork_preserved'], 87)
        self.assertEqual(report['complete_four_edge_borders'], 6)
        self.assertEqual(report['inter_tile_gap'], 8.0)
