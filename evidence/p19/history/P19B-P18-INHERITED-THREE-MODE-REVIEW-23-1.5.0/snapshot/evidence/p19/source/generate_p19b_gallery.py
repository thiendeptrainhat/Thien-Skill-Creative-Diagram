...
def main() -> None:
    ...
    if len(sources) != 30:
        raise RuntimeError("D-103 requires 25 canonical fixtures, four capability fixtures, one Layers variant, and the uniformly inset detailed Treemap")
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-100: remediated Venn as an original balanced three-set model with an exact clipped triple intersection and direct non-color labels; retained D-099–D-085 scope; 90 P-19 HTML, no owner approval or P-19C claim.",
    })
