...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-103 uniformly inset exact-area Treemap retaining D-084–D-102 scope; six complete four-edge borders/eight-unit inter-tile gaps/exact allocation-area hierarchy/one focal and one compact-label tile; frozen P-17/P-19A preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
