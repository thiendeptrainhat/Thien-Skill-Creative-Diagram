...
P19B_CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-40-1.5.0"
...
def render_gallery_html(ir_value: Mapping[str, Any], mode: str, fixture_id: str, *, connector_corner_style: str | None = None) -> str:
    ...
    identity = "layers" if is_layers_variant else "scatter-chart" if is_scatter_variant else "bubble" if adapter["capability_id"] == "CAP-V20" else adapter["capability_id"] or adapter["canonical_type"]
