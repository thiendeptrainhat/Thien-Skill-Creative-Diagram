...
def specimen_sources() -> list[tuple[str, str, dict]]:
    ...
    values.extend(
        (
            ...
            CAPABILITY_NAMES[capability] if capability == "CAP-V20" else capability,
            variants[capability],
        )
...
def main() -> None:
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097/D-098/D-099/D-100/D-105/D-106/D-108/D-109/D-110/D-111/D-112/D-113/D-114/D-115/D-116/D-117/D-118/D-119/D-120",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-120: renamed the CAP-V20 display identity to bubble while retaining CAP-V20 as the internal capability id and scatter-plot as canonical parent; replaced only its three visual modes with an original seven-point, area-faithful Bubble chart using the inherited P-18 template, exact axes/ticks/table and one redundantly identified focal bubble; retained D-119–D-085 scope; 93 P-19 HTML, no owner approval or P-19C claim.",
    })
