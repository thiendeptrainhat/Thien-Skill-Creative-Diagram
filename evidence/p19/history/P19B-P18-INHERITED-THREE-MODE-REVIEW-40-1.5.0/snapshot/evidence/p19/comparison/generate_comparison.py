...
PINS = {
    ...
    "evidence/p19/gallery/P-19B-MANIFEST.json": "369cf161211a4074c6714fb48003bac7453c5cf3e0d0fa1485ab9497fc9995ca",
    "evidence/p19/P-19B-SOURCE-MANIFEST.json": "8aac30cea0bd816d22d81b9e7e1f22c495de070d417f02c69d1d5562e2984e9c",
    "evidence/p19/P-19B-PLAN-MANIFEST.json": "d23ba1bca66bb2804dc3a6d2c4d7d9435d1060aa058b347b183a4a1e54521e53",
...
def generate():
    ...
    for anchor in anchors:
        ...
        for (_, fixture), modes in engine_groups:
            ...
            name = first["identity"] if not first["capability_id"] or first["capability_id"] == "CAP-V20" else fixture.removeprefix("cap-").upper()
...
<h1>P-18 ↔ P-19<br>Toàn bộ diagram, cùng một trang.</h1>
    ...
    <p class="note">Theo D-084/D-085/D-095–D-120: <strong>giữ nguyên 14 bản P-18, bỏ các bản P-19 trùng loại, giữ mọi remediation trước; đổi display identity CAP-V20 thành bubble và dùng đúng area-proportional Bubble chart trong template hiện hành</strong>. P-19 có 25 loại + 4 capability + 2 presentation variant, mỗi identity đủ 3 mode; P-18 chỉ dùng neutral-light đã duyệt, không tự tạo thêm màu.</p>
...
<a href="{link(P18 / 'index.html')}" target="_blank" rel="noopener">Mở gallery P-18 ↗</a></div>
    <div><strong>P-19B · review-40 · Chờ owner review</strong><code>{html.escape(b['candidate_id'])}</code>
