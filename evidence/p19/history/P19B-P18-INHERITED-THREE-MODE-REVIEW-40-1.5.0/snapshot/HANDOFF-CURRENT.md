# Handoff phiên mới — P-19B D-120 review-40 Bubble chart; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-120.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-40-1.5.0` theo D-120, giữ scope D-084–D-119: 14 P-18 anchor + 93 P-19 HTML/31 preview. Review-40 đổi display identity `CAP-V20-BUBBLE` thành `bubble`, giữ internal `CAP-V20`/parent `scatter-plot`, và thay riêng artwork bằng Bubble chart 7 điểm/3 series/2 trục/1 focal với area-proportional size encoding; template hiện tại giữ nguyên. 90 non-target HTML/30 preview được bảo toàn. Exact review-39 đã archive 591 file; 16948 protected file khớp. Owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-120; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-105 khóa global connector policy, D-113 khóa scatter-chart, D-114 khóa detailed radar, D-115 khóa solid-line radar, D-116 khóa marker-free radar plot, D-117 khóa detailed five-shape process, D-118 khóa continuous document connectors, D-119 khóa thin-stroke process và D-120 khóa Bubble identity/chart
...
### D-120 checkpoint hiện hành

Exact review-39 đã archive byte-bound trước mutation: 591 snapshot file và 16948 protected file khớp. Active review-40 đổi display identity thành `bubble` nhưng giữ internal `CAP-V20`/parent `scatter-plot`; chart có đúng 7 bubble, 3 series, 2 plain axis, 8 x-tick, 9 y-tick, 1 focal và 7 exact table row. `radius²/value = 57.8` không đổi nên diện tích bubble tỷ lệ magnitude; ba mode cùng geometry. Focused/scope 11/11, static 34/34, full regression 397/397 và exact verifier PASS; neutral-light raster 2000×1040 đã inspect. Owner approval pending; P-19C/G-04/package/release chưa được phép.
...
- P-17 semantic source vẫn đủ 39 type + bốn capability; P-19A registry không đổi. Gallery hiện hành giữ trực tiếp 14 P-18 anchor ở neutral-light, sinh 93 HTML P-19/31 identity theo D-085/D-095–D-120, gồm hai presentation variant `layers`/`scatter-chart`, display identity `bubble` với internal `CAP-V20`, và giữ global connector policy D-105 cùng mọi detailed remediation trước; owner approval pending.
