# Handoff phiên mới — P-19B D-100 review-20 exact three-set Venn; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-100.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-20-1.5.0` theo D-100, giữ scope D-084–D-099: 14 P-18 anchor + 90 P-19 HTML/30 preview. `venn` có 3 equal-radius set/4 member/1 exact nested-clipped triple intersection, direct set/core labels và exact membership table. Exact review-19 đã archive; 87 non-target HTML/29 non-target preview được bảo toàn. Focused 166/166, scope 8/8, static 34/34 và regression 328/328 PASS. Browser `BLOCKED_URL_POLICY`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-100; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086–D-099 khóa các remediation/addition chi tiết và D-100 khóa exact three-set `venn`
...
### D-100 checkpoint hiện hành

Exact review-19 đã archive byte-bound trước mutation. Active review-20 chỉ thay `venn`: ba equal-radius set, bốn member, một exact nested-clipped triple intersection, lower pair cân quanh top set, direct label cho từng set và core, cùng exact membership table. Archive 386 file và protected corpus 7207 file khớp; 87 non-target HTML giữ artwork sau candidate-ID normalization, 29 non-target preview byte-identical; tổng vẫn 90 P-19 HTML/30 preview và comparison có 104 diagram. Focused 166/166, scope 8/8, static 34/34, regression 328/328; neutral-light Quick Look raster đã inspect. In-app browser từ chối local file URL theo policy nên browser là `BLOCKED_URL_POLICY`, không bypass. Xem `evidence/p19/P-19B-REVIEW-20-VERIFICATION.json`; owner approval pending, P-19C/G-04/package/release chưa được phép.
...
- Active P-19B review-20: focused 166/166, scope 8/8, static 34/34, regression 328/328; Venn 3 equal-radius set/4 member/1 exact nested-clipped triple intersection cùng geometry qua ba mode; 87 non-target HTML giữ artwork, 29 preview byte-identical và exact P-18 anchors giữ nguyên. Quick Look chỉ là focused local raster, browser bị URL policy chặn; không thay browser/full visual PASS và không mở P-19C.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-100 review-20 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
