...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-100 exact three-set Venn retaining D-084–D-099 scope; three equal-radius sets/four members/one exact nested-clipped triple intersection/direct non-color labels; frozen P-17/P-19A preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
