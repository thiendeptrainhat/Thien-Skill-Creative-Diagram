...
- Preserve: exact P-18R6 review-17 SVG bytes and all non-target P-19B review-13
  artwork, typography, colors, text, geometry and paint order. Review-14 changes
  only Kanban relative to archived review-13; all retained detailed diagrams
  remain intact.
