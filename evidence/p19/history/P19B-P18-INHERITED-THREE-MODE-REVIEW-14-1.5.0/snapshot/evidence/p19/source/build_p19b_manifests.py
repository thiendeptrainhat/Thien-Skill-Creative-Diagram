...
CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-14-1.5.0"
...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-29",
        "boundary": "P-19B D-094 Kanban-only detailed WIP-board remediation retaining D-084–D-093 scope; four columns/11 items/redundant state encoding; frozen P-17 grammar preserved; 14 approved P-18 anchors + 87 P-19 HTML; owner review pending; P-19C not performed",
