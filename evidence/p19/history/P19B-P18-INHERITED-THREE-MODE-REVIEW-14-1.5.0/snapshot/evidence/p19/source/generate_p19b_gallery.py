...
def main() -> None:
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-094: Kanban four-column WIP remediation with explicit blocked/waiting/done states and one over-limit column; retaining D-093–D-085 scope; 87 P-19 HTML, no owner approval or P-19C claim.",
    })
