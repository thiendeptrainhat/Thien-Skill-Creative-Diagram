...
- tổng 87 P-19 specimen HTML + 14 P-18 anchor = 101 diagram tổng hợp; không tính index/contact sheet;
- 87/87 P-19 file phải có semantic fixture ID, type/parent/mode metadata, exact hash và automated check disposition; 14 P-18 anchor phải có exact source/hash binding và không đổi byte;
