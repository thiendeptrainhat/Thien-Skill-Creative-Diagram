...
**Phase đang thực hiện:** P-19B review-14 `in-progress`/owner-review-pending theo D-094, giữ scope D-084–D-093; exact review-13 archived; P-19 tổng thể `in-progress`; P-19C `not-started` và unauthorized
...
2. `P-19B` — remediation `in-progress` theo D-084–D-094: dùng trực tiếp 14 exact P-18R6 review-17 anchor, không tái sinh duplicate; 25 canonical type còn lại và bốn capability có ba mode, tổng 87 HTML/29 preview. Active review-14 giữ toàn bộ D-086–D-093 và thay riêng Kanban bằng board bốn cột có exact WIP/state encoding. Giữ gallery/comparison đủ 101 diagram, không derive thêm màu P-18, bảo toàn artwork P-19 ngoài Kanban/candidate metadata và giữ withdrawal custody để khôi phục.
...
**Checkpoint D-094:** active candidate `P19B-P18-INHERITED-THREE-MODE-REVIEW-14-1.5.0`. Review-13 đã archive 311 files; protected corpus 5143 files khớp hash. Chỉ 3 Kanban HTML và preview Kanban thay artwork; 84 non-target HTML giữ nguyên sau candidate-ID normalization, 28 non-target preview byte-identical. Kanban có đúng 4 cột/11 item theo 3/4/2/2, một WIP breach `4/3`, một blocked, một waiting-external và hai done; state có non-color encoding, card containment và exact alternative table; geometry ba mode được giữ. Focused 116/116, scope 8/8, static 32/32 và full regression 278/278 PASS; neutral-light raster đã inspect. Chi tiết `evidence/p19/P-19B-REVIEW-14-VERIFICATION.json`; browser blocked, owner approval pending, P-19C unauthorized, G-04 NOT-EVALUATED.
