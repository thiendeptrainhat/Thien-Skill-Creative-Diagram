...
def main() -> None:
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097/D-098/D-099/D-100/D-105/D-106/D-108/D-109/D-110/D-111/D-112/D-113/D-114/D-115/D-116",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-113: added an independently authored scatter-chart presentation variant under the frozen P-18 scatter-plot parent: 12 exact team pairs, truthful 0–20/0–24 linear axes, one redundant coral focal point and an OLS descending trend; retained D-112–D-085 scope; 93 P-19 HTML, no owner approval or P-19C claim.",
    })
