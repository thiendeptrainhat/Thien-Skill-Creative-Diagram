#!/usr/bin/env python3
"""Preserve exact D-095 review-15 before line-chart review-16."""
import hashlib
import json
import shutil
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-15-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        "candidate_id": "P19B-P18-INHERITED-THREE-MODE-REVIEW-15-1.5.0",
        "disposition": "historical before D-096 line-chart remediation; not owner approval",
        "manifest_pins": PINS,
