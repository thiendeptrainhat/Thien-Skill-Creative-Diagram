#!/usr/bin/env python3
"""D-102 bordered Treemap verification against archived review-21 bytes."""
...
OLD = "P19B-P18-INHERITED-THREE-MODE-REVIEW-21-1.5.0"
ARCHIVE = ROOT / "evidence/p19/history" / OLD
GALLERY = ROOT / "evidence/p19/gallery"
PROOFS = ROOT / "evidence/p19/review22-checks"
...
def verify():
    ...
    for record in targets:
        ...
        require(svg.count('class="tm-gutter"') == 6, "Every tile must retain a visible separation gutter")
    ...
    return {
        ...
        "tiles": 6,
        "visible_tile_borders": 6,
        "separation_gutters": 6,
        "exact_area_tiles": 6,
        "focal_tiles": 1,
...
if __name__ == "__main__":
    report = verify()
    output = ROOT / "evidence/p19/P-19B-REVIEW-22-VERIFICATION.json"
