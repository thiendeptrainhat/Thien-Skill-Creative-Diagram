...
def main() -> None:
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097/D-098/D-099/D-100/D-105/D-106/D-108/D-109/D-110/D-111/D-112/D-113/D-114/D-115/D-116/D-117/D-118",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-118: repaired only process connector continuity; five document-bound connectors meet the visible shape boundary, and the two approval-pack merge routes are symmetric rounded-orthogonal paths with explicit arrowheads; retained D-117–D-085 scope and the existing template; 93 P-19 HTML, no owner approval or P-19C claim.",
    })
