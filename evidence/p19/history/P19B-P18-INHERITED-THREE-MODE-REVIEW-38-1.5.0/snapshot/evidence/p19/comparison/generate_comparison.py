...
PINS = {
    ...
    "evidence/p19/gallery/P-19B-MANIFEST.json": "e5a0dfd7dc5c1a033f2cf0827627e6e98c67f0bc4868d4b6b60acc4783108956",
    "evidence/p19/P-19B-SOURCE-MANIFEST.json": "3aa0ded6e429faba0140910b73339f81547a4bb06b22636480d70a5ac17e5c56",
    "evidence/p19/P-19B-PLAN-MANIFEST.json": "7eb324b1e25bbee87468314dd149abdd9c5c9f3844c5baf271d317a3d04adb85",
...
<h1>P-18 ↔ P-19<br>Toàn bộ diagram, cùng một trang.</h1>
    ...
    <p class="note">Theo D-084/D-085/D-095–D-118: <strong>giữ nguyên 14 bản P-18, bỏ các bản P-19 trùng loại, giữ mọi remediation trước và sửa riêng process để connector document liền mạch, với hai luồng hội tụ vuông góc bo tròn</strong>. P-19 có 25 loại + 4 capability + 2 presentation variant, mỗi identity đủ 3 mode; P-18 chỉ dùng neutral-light đã duyệt, không tự tạo thêm màu.</p>
...
<a href="{link(P18 / 'index.html')}" target="_blank" rel="noopener">Mở gallery P-18 ↗</a></div>
    <div><strong>P-19B · review-38 · Chờ owner review</strong><code>{html.escape(b['candidate_id'])}</code>
