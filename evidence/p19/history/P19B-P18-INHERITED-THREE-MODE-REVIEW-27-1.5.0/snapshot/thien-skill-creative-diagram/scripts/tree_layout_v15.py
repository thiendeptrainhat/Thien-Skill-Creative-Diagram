...
def tree_css(tokens):
    return """
    .tree-wire{fill:none;stroke:var(--connector);stroke-width:1.6;stroke-linecap:square;vector-effect:non-scaling-stroke}
    .tree-card-shape{fill:var(--surface);stroke:var(--connector);stroke-width:1.8;vector-effect:non-scaling-stroke}
    .tree-card.is-root .tree-card-shape{fill:var(--accent-soft);stroke:var(--accent);stroke-width:2.2}
