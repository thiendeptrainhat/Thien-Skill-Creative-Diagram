...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-107 thin-stroke detailed tree with P-18 org-chart centered-span geometry, retaining D-085–D-106 scope; frozen P-17/P-19A preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
