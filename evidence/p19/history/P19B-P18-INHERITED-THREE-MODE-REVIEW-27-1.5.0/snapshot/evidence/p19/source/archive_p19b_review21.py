#!/usr/bin/env python3
"""Preserve exact D-101 review-21 before bordered Treemap review-22."""
import hashlib
import json
import shutil
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-21-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        ...
        "disposition": "historical before D-102 bordered Treemap remediation; not owner approval",
        "manifest_pins": PINS,
