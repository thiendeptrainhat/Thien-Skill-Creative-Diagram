# Handoff phiên mới — P-19B D-107 review-27 thin-stroke centered tree; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-107.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-27-1.5.0` theo D-107, giữ scope D-084–D-106: 14 P-18 anchor + 90 P-19 HTML/30 preview. Tree giữ exact geometry D-106 nhưng dùng nét mảnh: connector `1.6`, card `1.8`, root `2.2`. Exact review-26 đã archive 459 file; 10143 protected file khớp. Focused D-107 và preservation verification PASS; browser `BLOCKED_URL_POLICY`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-107; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor, D-086–D-104 khóa các remediation/addition chi tiết, D-105 khóa global connector policy, D-106 khóa detailed centered-span tree và D-107 khóa thin-stroke refinement
...
### D-107 checkpoint hiện hành

Exact review-26 đã archive byte-bound trước mutation: 459 snapshot file và 10143 protected file khớp. Active review-27 chỉ hạ paint weight của `tree`: hierarchy connector `2.6→1.6`, card thường `2.4→1.8`, root focal `3.0→2.2`. Toàn bộ 9 node/8 relation/3 tầng/14 straight primitive, tọa độ card/text/connector, centered-span fanout và geometry ba mode giữ nguyên review-26. 87 non-target HTML giữ artwork sau candidate normalization và 29 non-target preview byte-identical. Focused 6/6, scope 8/8, static 34/34 và regression 357/357 PASS. Xem `evidence/p19/P-19B-REVIEW-27-VERIFICATION.json`; owner approval pending, P-19C/G-04/package/release chưa được phép.
...
- P-17 semantic source vẫn đủ 39 type + bốn capability; P-19A registry không đổi. Gallery hiện hành giữ trực tiếp 14 P-18 anchor ở neutral-light, sinh 90 HTML P-19/30 identity theo D-085/D-095–D-107, áp dụng global connector policy D-105, detailed centered-span tree D-106 và thin-stroke refinement D-107; owner approval pending.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-107 review-27 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
