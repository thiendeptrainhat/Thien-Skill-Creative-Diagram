...
**Checkpoint D-107:** active candidate `P19B-P18-INHERITED-THREE-MODE-REVIEW-27-1.5.0`. Review-26 đã archive 459 files; protected corpus 10143 files khớp hash. Chỉ paint weight của 3 tree HTML và một preview đổi: connector `1.6`, card thường `1.8`, root focal `2.2`; mọi emitted geometry element giữ nguyên review-26. 87 non-target HTML giữ nguyên sau candidate normalization, 29 preview byte-identical. Tree vẫn có 9 node/8 relation/3 tầng/14 straight connector primitive và exact centered-span geometry D-106. Focused tree 6/6, scope 8/8, static 34/34 và full regression 357/357 PASS. Verification/hash xem `evidence/p19/P-19B-REVIEW-27-VERIFICATION.json`; owner approval pending, P-19C unauthorized, G-04 NOT-EVALUATED.
