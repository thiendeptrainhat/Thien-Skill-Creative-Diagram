# Handoff phiên mới — P-19B D-117 review-37 detailed process; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-117.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-37-1.5.0` theo D-117, giữ scope D-084–D-116: 14 P-18 anchor + 93 P-19 HTML/31 preview. Review-37 thay riêng `process` bằng quy trình độc lập có 3 terminator, 4 process, 2 decision, 1 document, 1 multiple-document và 11 directed straight route; 90 non-target HTML/30 preview được bảo toàn. Exact review-36 đã archive 564 file; 15223 protected file khớp. Owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-117; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-105 khóa global connector policy, D-113 khóa scatter-chart, D-114 khóa detailed radar, D-115 khóa solid-line radar, D-116 khóa marker-free radar plot và D-117 khóa detailed five-shape process
