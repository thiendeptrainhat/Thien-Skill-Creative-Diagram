# Handoff phiên mới — P-19B D-086 review-06 detailed Fishbone; owner review pending; P-19C unauthorized
...
2. `PROJECT-CONTRACT.md` — yêu cầu, phạm vi và decision ledger D-001 đến D-086.
...
- P-19: `in-progress`; P-19A `passed`. Active P-19B `P19B-P18-INHERITED-THREE-MODE-REVIEW-06-1.5.0` theo D-086, giữ scope D-084/D-085: 14 P-18 anchor + 87 P-19 HTML/29 preview. Fishbone có 5 nhóm/10 nguyên nhân/1 hệ quả; focused 60/60, scope 8/8, static 32/32 và regression 222/222 PASS. Browser `blocked / not executable`; owner approval pending. P-19C `not-started`/unauthorized, G-04 NOT-EVALUATED; không package/dist/publication/Git/Release.
...
- `PLAN.md`
- `PROJECT-CONTRACT.md` — D-001 đến D-086; D-077 khóa owner approval/G-03/P-18 closure, D-078 authorize/đóng P-19A, D-079 ghi historical technical candidate đầu P-19B, D-080 khóa owner rejection cùng P-18-inherited successor và D-086 giới hạn review-06 ở Fishbone
...
- Active P-19B review-06: focused tests 60/60, static 32/32; Fishbone 5 nhóm/10 nguyên nhân/1 hệ quả cùng geometry qua ba mode; 84 non-target HTML giữ artwork, 28 preview byte-identical và exact P-18 anchors giữ nguyên. Quick Look chỉ là focused local raster, không thay browser/full visual PASS và không mở P-19C.
...
- [x] P-18 `passed`; exact P-18R6 review-17 frozen/owner-approved và `G-03@1.5.0 PASS`; P-19A `passed`; active P-19B D-086 review-06 successor `in-progress`/owner-review-pending; P-19C chưa được phép và G-04@1.5.0 vẫn `NOT-EVALUATED`.
