...
def main() -> None:
    ...
    if len(sources) != 30:
        raise RuntimeError("D-099 requires 25 canonical fixtures, four capability fixtures, one Layers variant, and the detailed Wardley map")
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097/D-098/D-099",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-099: remediated wardley-map as an original eight-component visibility/evolution value chain with one non-color redundant evolution signal; retained D-098–D-085 scope; 90 P-19 HTML, no owner approval or P-19C claim.",
    })
