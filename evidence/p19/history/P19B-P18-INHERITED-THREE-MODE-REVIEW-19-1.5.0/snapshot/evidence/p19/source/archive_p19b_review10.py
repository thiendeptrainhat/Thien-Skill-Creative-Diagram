#!/usr/bin/env python3
"""Preserve exact D-090 review-10 before inline-cardinality review-11."""
import hashlib
import json
...
DEST = ROOT / "evidence/p19/history/P19B-P18-INHERITED-THREE-MODE-REVIEW-10-1.5.0"
PINS = {
...
def main():
    ...
    receipt = {
        ...
        "disposition": "historical before D-091 er-data-model inline-cardinality-only remediation; not owner approval",
        "manifest_pins": PINS,
