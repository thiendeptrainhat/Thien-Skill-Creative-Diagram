...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-099 detailed Wardley map retaining D-084–D-098 scope; eight components/nine dependencies/two normalized axes/four stages/one non-color redundant evolving signal; frozen P-17/P-19A preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
