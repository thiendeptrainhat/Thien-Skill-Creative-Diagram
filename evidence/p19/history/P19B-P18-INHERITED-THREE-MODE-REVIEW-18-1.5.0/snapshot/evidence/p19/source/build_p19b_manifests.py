...
def main() -> None:
    ...
    plan = {
        ...
        "date": "2026-08-30",
        "boundary": "P-19B D-098 detailed polar-chart retaining D-084–D-097 scope; one series/eight UTC windows/eight proportional common-origin spokes/five rings/one non-color redundant unique peak; frozen P-17/P-19A preserved; 14 approved P-18 anchors + 90 P-19 HTML; owner review pending; P-19C not performed",
