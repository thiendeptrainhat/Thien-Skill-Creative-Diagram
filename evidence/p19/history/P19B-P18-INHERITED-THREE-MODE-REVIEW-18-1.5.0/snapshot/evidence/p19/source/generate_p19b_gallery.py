...
def main() -> None:
    ...
    if len(sources) != 30:
        raise RuntimeError("D-098 requires 25 canonical fixtures, four capability fixtures, one Layers variant, and the detailed polar chart")
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097/D-098",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-098: remediated polar-chart as an original eight-window radial-spoke comparison on an exact 0–100 percent scale; retained D-097–D-085 scope; 90 P-19 HTML, no owner approval or P-19C claim.",
    })
