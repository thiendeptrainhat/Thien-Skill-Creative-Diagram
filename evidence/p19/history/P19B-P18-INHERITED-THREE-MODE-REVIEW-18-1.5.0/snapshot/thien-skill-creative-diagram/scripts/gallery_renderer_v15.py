...
P19B_CANDIDATE_ID = "P19B-P18-INHERITED-THREE-MODE-REVIEW-18-1.5.0"
...
def validate_target_geometry(svg: str, diagram_type: str) -> dict[str, Any]:
    ...
    if diagram_type not in ("dp-integration", "swimlane", "bar-chart", "line-chart", "polar-chart", "dp-security-matrix", "er-data-model", "high-level", "it-current-state", "kanban", "layer-stack", "medallion"):
        return {}
