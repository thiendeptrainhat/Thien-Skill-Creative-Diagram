...
def specimen_sources() -> list[tuple[str, str, dict]]:
    ...
    canonical['nested'] = nested_fixture()
...
def main() -> None:
    ...
    inventory = {
        ...
        "reuse_authority": "D-084/D-085/D-095/D-096/D-097/D-098/D-099/D-100/D-105/D-106/D-108/D-109/D-110/D-111/D-112/D-113/D-114/D-115/D-116/D-117/D-118/D-119/D-120/D-121/D-122/D-123/D-124/D-125",
        "capability_count": 4,
        "mode_count": 3,
    ...
    write_json(MANIFEST_PATH, {
        ...
        "note": "D-125: replaced only the three canonical nested modes with an original five-depth enterprise configuration containment using the inherited P-18 template, five exact artifacts, one focal core and one inheritance annotation leader; retained D-124–D-085 scope including detailed layer-stack and the separate layers presentation variant; 93 P-19 HTML, no owner approval or P-19C claim.",
    })
