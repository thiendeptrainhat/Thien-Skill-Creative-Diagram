...
const out = path.join(root, 'evidence/p19/review27-checks');
...
console.log(JSON.stringify({ width: 2000, height: 920, proof: 'evidence/p19/review27-checks/type-tree.svg.png' }));
